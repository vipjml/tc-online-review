...
/**
 * Failure tests of methods of DefaultConfigManager. Add failure tests for Config Mamanager 2.2
 *
 * @author WishingBone, onsky
 * @version 1.1
 */
...
/** prepared test files to destroy */
    ...
    /**
     * Creates a new DefaultConfigManagerFailureTest object.
     *
    ...
    /**
     * testing exceptions for add with two String argument and exception level
     */
    ...
    /**
     * testing exceptions for add with arguments: namespace, filename, format, exception level and exception
     * level
     */
    ...
    /**
     * Failure tests for refreshAll method.
     *
     * @throws Exception if any
     */
    public void testRefreshAll() throws Exception {
        try {
            cm.setConfigRefreshableByDefault(true);
            String s = prepareXMLFile("failure-test");
            cm.add(s, ConfigManager.CONFIG_XML_FORMAT);
            for (File file : createdFiles) {
                file.delete();
    ...
    /**
     * Failure tests for refresh method.
     *
     * @throws Exception if any
     */
    ...
    public void testRefresh2() throws Exception {
        try {
            cm.setConfigRefreshableByDefault(true);
            cm.refresh("unknown");
            fail("UnknownNamespaceException is expected");
        } catch (UnknownNamespaceException e) {
            // good
        }
    }

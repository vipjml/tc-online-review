 ...
 * <ol>
 * <li>Used generic types instead. Refer to changes note for fields and methods.</li>
...
public class Property implements Cloneable {
    ...
    /**
     * <p>
     * A List of string comments associated with this element. To leverage the memory usage the memory space for
     * comments is allocated only when there is a first attempt to add some comment to this list.
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
     * <ol>
     * <li>Added a generic parameter.</li>
     * </ol>
     * </p>
     */
     ...
     * </p>
     */
    private List<Property> subproperties = null;

    /**
     * <p>
     * A <code>List</code> of mulpile <code>String</code> values associated with this <code>Property</code>.
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
    ...
    /**
     * Constructs a new <code>Property</code> with given <code>name</code> and given value.
     *
     * @param name
     *            a name of this property uniquely identifying it among others
     * @param value
     *            a value of this property
     * @throws IllegalArgumentException
     *             if given <code>name</code> is <code>
     *         empty</code> or is a compound name
     * @throws NullPointerException
     *             if any of given <code>name</code> or <code>value</code> is <code>null</code>
     */
    ...
    /**
     * Constructs a new <code>Property</code> with given <code>name</code> and given list of associated values.
     *
     * @param name
     *            a name of newly created property uniquely identifying it among others
     * @param values
     *            a list of values associated with this property
     * @throws IllegalArgumentException
     *             if given <code>name</code> is <code>
     *         empty</code> or is a <code>compound name</code>
     * @throws NullPointerException
     *             if any of given <code>name</code> or <code>values</code> is <code>null</code>
     */
     ...
     * <em>Changes in 2.2:</em>
     * <ol>
     * <li>Added parameter documentation for separator.</li>
     * </ol>
     * </p>
     *
     * @param separator
    ...
    /**
     * Adds property specified with given name and value to list of actual properties nested directly within this
     * property. Creates a <code>Property</code> object with given name holding given value.
     *
     * @param name
     *            a name of added property
     * @param value
     *            a value of added property
     * @throws DuplicatePropertyException
     *             if property with given <code>name
    ...
    /**
     * Adds property specified with given name and values to list of properties nested directly within this property.
     * Creates a <code>Property</code> object from given name holding given values.
     *
     * @param name
     *            a name of added property
     * @param values
     *            a values of added property
     * @throws DuplicatePropertyException
     *             if property with given <code>name
     *         </code> already exists within this <code>Property</code>
     * @throws IllegalArgumentException
    ...
    void addProperty(Property property) throws DuplicatePropertyException {
        ...
        for (Iterator<Property> itr = subproperties.iterator(); itr.hasNext();) {
            if (itr.next().name.equals(property.name)) {
                throw new DuplicatePropertyException("property " + name + " already exists");
            }
        }
    ...
    void removeProperty(String name) {
        ...
        for (Iterator<Property> itr = property.subproperties.iterator(); itr.hasNext();) {
    ...
    /**
     * <p>
     * Gets all the values of this Property.
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
     * <ol>
     * <li>Wrong method description was fixed.</li>
     * </ol>
     * </p>
     *
    ...
    public List<Property> list() {
        return new ArrayList<Property>(subproperties);
    }
    ...
    public Object clone() {
        ...
        property.values = new ArrayList<String>(values);
        property.subproperties = new ArrayList<Property>();
        for (Iterator<Property> itr = subproperties.iterator(); itr.hasNext();) {
            property.subproperties.add((Property) itr.next().clone());
        }
        if (comments != null) {
            property.comments = new ArrayList<String>(comments);
        }
        return property;
    }
     ...
     * Any previous comments are removed.
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
     * <ol>
     * <li>Added a generic parameter to the "comments" parameter.</li>
     * </ol>
     * </p>
     *
    ...
    public void setComments(List<String> comments) {
        if (comments == null) {
            ...
            for (Iterator<String> itr = comments.iterator(); itr.hasNext();) {
                if (itr.next() == null) {
                    throw new IllegalArgumentException("parameter comments contains null entry");
                }
            }
     ...
     * <em>Changes in 2.2:</em>
     * <ol>
     * <li>Renamed "o" to "obj".</li>
     * </ol>
     * </p>
     *
     * @param  obj the object to compare this <code>Property</code> against
     * @return <code>true</code> if the property names are equal or
     *         their hash codes are equal; <code>false</code> otherwise
     */
    public boolean equals(Object obj) {
        return (obj instanceof Property) && name.equals(((Property) obj).name);
    }

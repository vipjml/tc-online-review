...
/**
 * <p>
 * A namespace existing within <code>Configuration Manager</code>. Is described with name uniquely identifying it
 * among other namespaces, format of source containing the properties of namespace, URL pointing to source containing
 * the properties of namespace, level of exceptions and <code>ConfigProperties</code> associated with it.
 * </p>
 *
 * <p>
 * Before attempting to make any updates to namespace a namespace should be locked first with <code>lock()</code>
 * method. After namespace has been locked and all updates have been made a namespace should be unlocked with
 * <code>unlock()</code> method. <code>canLock()</code> can be used to check whether this namespace can be locked by
 * given user or not.
 * </p>
 *
 * <p>
 ...
 * <ol>
 * <li>Made <code>name</code>, <code>format</code>, <code>file</code> and <code>exceptionLevel</code> final.</li>
...
class Namespace {
    ...
    /**
     * <p>
     * A name uniquely identifying this namespace among other namespaces existing within
    ...
    /**
     * <p>
     * An <code>URL</code> pointing to source of properties containing within this namespace.
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
     ...
     * <code>ConfigManager.EXCEPTION_MAJOR</code>).
     * </p>
     *
     * <p>
     * <em>Changes in 2.2:</em>
     ...
     */
    private final int exceptionLevel;
     ...
     *         or <code>ConfigManager.EXCEPTION_MAJOR</code>)
     * @see ConfigManager#EXCEPTION_ALL
     * @see ConfigManager#EXCEPTION_MAJOR
     */

...
/**
 * Accuracy test for SubmissionPhaseHandler class.
 *
 * @author tuenm
 * @version 1.0
 */
public class SubmissionPhaseHandlerAccTest extends BaseAccuracyTest {
    /**
     * <p/>
     ...
     * @throws Exception pass any unexpected exception to JUnit.
     */
    public void testSubmissionPhaseHandler() throws Exception {
        new SubmissionPhaseHandler(PHASE_HANDLER_NS);
    ...
    public void testCanPerformStartDepClosed() throws Exception {
        SubmissionPhaseHandler handler = new SubmissionPhaseHandler(PHASE_HANDLER_NS);
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Submission", "Registration", project, true);

            Phase phase = AccuracyTestHelper.getPhase("Submission", phases);
    ...
    public void testCanPerformStartDepOpen() throws Exception {
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Submission", "Registration", project, false);
     ...
     * phase status is closed. The result is expected to be false because end date is not reached.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     */
    public void testCanPerformEndDepClosedEndDateNotReached() throws Exception {
        SubmissionPhaseHandler handler = new SubmissionPhaseHandler(PHASE_HANDLER_NS);

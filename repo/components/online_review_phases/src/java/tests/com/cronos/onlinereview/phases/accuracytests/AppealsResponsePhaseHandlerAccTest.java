...
/**
 * Accuracy test for AppealsResponsePhaseHandler class.
 *
 * @author tuenm
 * @version 1.0
 */
public class AppealsResponsePhaseHandlerAccTest extends BaseAccuracyTest {
    /**
     * <p/>
     ...
     * @throws Exception pass any unexpected exception to JUnit.
     */
    public void testAppealsResponsePhaseHandler() throws Exception {
        new AppealsResponsePhaseHandler(PHASE_HANDLER_NS);
    ...
    public void testCanPerformStartDepClosed() throws Exception {
        AppealsResponsePhaseHandler handler = new AppealsResponsePhaseHandler(PHASE_HANDLER_NS);
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Appeals Response", "Appeals", project, true);

            Phase phase = AccuracyTestHelper.getPhase("Appeals Response", phases);
    ...
    public void testCanPerformStartDepOpen() throws Exception {
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Appeals Response", "Appeals", project, false);
            ...
            assertEquals("Wrong message",  "Dependency Appeals phase is not yet ended.",  result.getMessage());
        } finally {
            AccuracyTestHelper.closeConnection();
            AccuracyTestHelper.cleanTables();
        }

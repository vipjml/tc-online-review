...
/**
 * <p>A failure test for {@link AggregationPhaseHandler} class. Tests the proper handling
 ...
 * @version 1.0
 */
public class AggregationPhaseHandlerFailureTest extends AbstractTestCase {

    /**
     * <p>The instances of {@link AggregationPhaseHandler} which are tested. These instances are initialized in {@link
     ...
     */
    private AggregationPhaseHandler[] testedInstances = null;

    /**
     * <p>Gets the test suite for {@link AggregationPhaseHandler} class.</p>
     *
     * @return a <code>TestSuite</code> providing the tests for {@link AggregationPhaseHandler} class.
     */
    public static Test suite() {
        return new TestSuite(AggregationPhaseHandlerFailureTest.class);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        this.testedInstances = new AggregationPhaseHandler[2];
        this.testedInstances[0] = new AggregationPhaseHandler();
        this.testedInstances[1] = new AggregationPhaseHandler(TestDataFactory.NAMESPACE);
    }
    ...
    /**
     * <p>Failure test. Tests the {@link AggregationPhaseHandler#AggregationPhaseHandler(String)} constructor for proper
    ...
    public void testConstructor_String_namespace_null() {
        try {
            new AggregationPhaseHandler(null);
    ...
    public void testConstructor_String_namespace_ZERO_LENGTH_STRING() {
        try {
            new AggregationPhaseHandler(TestDataFactory.ZERO_LENGTH_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testConstructor_String_namespace_WHITESPACE_ONLY_STRING() {
        try {
            new AggregationPhaseHandler(TestDataFactory.WHITESPACE_ONLY_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    /**
     * <p>Failure test. Tests the {@link AggregationPhaseHandler#canPerform(Phase)} method for proper handling the
     ...
     * invalid input arguments.</p>
     *
     * <p>Passes {@link TestDataFactory#getClosedAggregationPhase()} as <code>phase</code> and expects the
     * <code>PhaseHandlingException</code> to be thrown.</p>
     */
    public void testCanPerform_Phase_phase_ClosedAggregationPhase() {
        for (int i = 0; i < this.testedInstances.length; i++) {
            try {
                this.testedInstances[i].canPerform(TestDataFactory.getClosedAggregationPhase());
    ...
    /**
     * <p>Failure test. Tests the {@link AggregationPhaseHandler#perform(Phase,String)} method for proper handling the
     * invalid input arguments.</p>
     *
     * <p>Passes {@link null} as <code>phase</code> and expects the <code>IllegalArgumentException</code> to be
     * thrown.</p>
     ...
     * <code>PhaseHandlingException</code> to be thrown.</p>
     */
    public void testPerform_Phase_String_phase_ClosedAggregationPhase() {
        for (int i = 0; i < this.testedInstances.length; i++) {
            try {
                this.testedInstances[i].perform(TestDataFactory.getClosedAggregationPhase(), TestDataFactory.OPERATOR);
                Assert.fail("PhaseHandlingException should have been thrown");
            } catch (PhaseHandlingException e) {
                // expected behavior
            } catch (Exception e) {
    ...
    public void testPerform_Phase_String_operator_null() {
        for (int i = 0; i < this.testedInstances.length; i++) {
            try {
                this.testedInstances[i].perform(TestDataFactory.getAggregationPhase(), null);
                Assert.fail("IllegalArgumentException should have been thrown");
            } catch (IllegalArgumentException e) {
                // expected behavior
            } catch (Exception e) {
    ...
    public void testPerform_Phase_String_operator_ZERO_LENGTH_STRING() {
        for (int i = 0; i < this.testedInstances.length; i++) {
            try {
                this.testedInstances[i].perform(TestDataFactory.getAggregationPhase(),
    ...
    /**
     * <p>Failure test. Tests the {@link AggregationPhaseHandler#canPerform,Phase} for proper behavior if the underlying
    ...
    /**
     * <p>Failure test. Tests the {@link AggregationPhaseHandler#perform,Phase,String} for proper behavior if the
    ...
    public void testPerform_Phase_String_ScheduledPhase_ResourceManagerError_SearchBuilderConfigurationException() {
        ...
        for (int i = 0; i < this.testedInstances.length; i++) {
            try {
                this.testedInstances[i].perform(TestDataFactory.getAggregationPhase(), TestDataFactory.OPERATOR);
                Assert.fail("PhaseHandlingException should have been thrown");
            } catch (PhaseHandlingException e) {
                // expected behavior
            } catch (Exception e) {

...
/**
 * Accuracy test for FinalReviewPhaseHandler class.
 *
 * @author tuenm
 * @version 1.0
 */
public class FinalReviewPhaseHandlerAccTest extends BaseAccuracyTest {
    /**
     * <p/>
     ...
     * @throws Exception pass any unexpected exception to JUnit.
     */
    public void testFinalReviewPhaseHandler() throws Exception {
        new FinalReviewPhaseHandler(PHASE_HANDLER_NS);
    ...
    public void testCanPerformStartDepClosed() throws Exception {
        FinalReviewPhaseHandler handler = new FinalReviewPhaseHandler(PHASE_HANDLER_NS);
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Final Review", "Final Fix", project, true);

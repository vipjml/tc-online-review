...
/**
 * <p>A failure test for {@link ResourceRoleLookupUtility} class. Tests the proper
 ...
 * @version 1.0
 */
public class ResourceRoleLookupUtilityFailureTest extends AbstractTestCase {

    /**
     * <p>Gets the test suite for {@link ResourceRoleLookupUtility} class.</p>
     *
     * @return a <code>TestSuite</code> providing the tests for {@link ResourceRoleLookupUtility} class.
     */
    public static Test suite() {
        return new TestSuite(ResourceRoleLookupUtilityFailureTest.class);
    }
    ...
    /**
     * <p>Failure test. Tests the {@link ResourceRoleLookupUtility#lookUpId(Connection,String)} method for proper
    ...
    public void testLookUpId_Connection_String_connection_null() {
        try {
            ResourceRoleLookupUtility.lookUpId(null, "Accuracy Reviewer");
    ...
    public void testLookUpId_Connection_String_value_null() {
        try {
            ResourceRoleLookupUtility.lookUpId(TestDataFactory.getConnection(), null);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_ZERO_LENGTH_STRING() {
        try {
            ResourceRoleLookupUtility.lookUpId(TestDataFactory.getConnection(), TestDataFactory.ZERO_LENGTH_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_WHITESPACE_ONLY_STRING() {
        try {
            ResourceRoleLookupUtility.lookUpId(TestDataFactory.getConnection(), TestDataFactory.WHITESPACE_ONLY_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_UNKNOWN_LOOKUP_VALUE() {
        try {
            ResourceRoleLookupUtility.lookUpId(TestDataFactory.getConnection(), TestDataFactory.UNKNOWN_LOOKUP_VALUE);
    ...
    /**
     * <p>Failure test. Tests the {@link ResourceRoleLookupUtility#lookUpId,Connection,String} for proper behavior if

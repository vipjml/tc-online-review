...
/**
 * <p>A failure test for {@link ProjectInfoTypeLookupUtility} class. Tests the
 * proper handling of invalid input data by the methods. Passes the invalid arguments to the methods and expects the
 * appropriate exception to be thrown.</p>
 *
 * @author isv
 * @version 1.0
 */
public class ProjectInfoTypeLookupUtilityFailureTest extends AbstractTestCase {

    /**
     * <p>Gets the test suite for {@link ProjectInfoTypeLookupUtility} class.</p>
     *
     * @return a <code>TestSuite</code> providing the tests for {@link ProjectInfoTypeLookupUtility} class.
     */
    public static Test suite() {
        return new TestSuite(ProjectInfoTypeLookupUtilityFailureTest.class);
    }
    ...
    /**
     * <p>Failure test. Tests the {@link ProjectInfoTypeLookupUtility#lookUpId(Connection,String)} method for proper
    ...
    public void testLookUpId_Connection_String_connection_null() {
        try {
            ProjectInfoTypeLookupUtility.lookUpId(null, "Project Name");
    ...
    public void testLookUpId_Connection_String_value_null() {
        try {
            ProjectInfoTypeLookupUtility.lookUpId(TestDataFactory.getConnection(), null);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_ZERO_LENGTH_STRING() {
        try {
            ProjectInfoTypeLookupUtility.lookUpId(TestDataFactory.getConnection(), TestDataFactory.ZERO_LENGTH_STRING);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_WHITESPACE_ONLY_STRING() {
        try {
            ProjectInfoTypeLookupUtility.lookUpId(TestDataFactory.getConnection(),
    ...
    /**
     * <p>Failure test. Tests the {@link ProjectInfoTypeLookupUtility#lookUpId,Connection,String} for proper behavior if
    ...
    public void testLookUpId_Connection_String_SQLError() {
        ...
        try {
            ProjectInfoTypeLookupUtility.lookUpId(TestDataFactory.getMockConnection(), "Project Name");
            Assert.fail("SQLException should have been thrown");
        } catch (SQLException e) {
            // expected behavior
        } catch (Exception e) {

...
/**
 * Accuracy test for RegistrationPhaseHandler class.
 *
 * @author tuenm
 * @version 1.0
 */
public class RegistrationPhaseHandlerAccTest extends BaseAccuracyTest {
    /**
     * <p/>
    ...
    public void testRegistrationPhaseHandler() throws Exception {
        new RegistrationPhaseHandler(PHASE_HANDLER_NS);
    ...
    public void testCanPerformStartDepClosed() throws Exception {
        RegistrationPhaseHandler handler = new RegistrationPhaseHandler(PHASE_HANDLER_NS);
        ...
        try {
            ...
            AccuracyTestHelper.addDependency("Registration", "Approval", project, true);

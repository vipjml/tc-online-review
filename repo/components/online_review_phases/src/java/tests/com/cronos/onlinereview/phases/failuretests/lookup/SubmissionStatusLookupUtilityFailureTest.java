...
/**
 * <p>A failure test for {@link SubmissionStatusLookupUtility} class. Tests the
 ...
 * @version 1.0
 */
public class SubmissionStatusLookupUtilityFailureTest extends AbstractTestCase {

    /**
     * <p>Gets the test suite for {@link SubmissionStatusLookupUtility} class.</p>
     *
     * @return a <code>TestSuite</code> providing the tests for {@link SubmissionStatusLookupUtility} class.
     */
    public static Test suite() {
        return new TestSuite(SubmissionStatusLookupUtilityFailureTest.class);
    }
    ...
    /**
     * <p>Failure test. Tests the {@link SubmissionStatusLookupUtility#lookUpId(Connection,String)} method for proper
    ...
    public void testLookUpId_Connection_String_connection_null() {
        try {
            SubmissionStatusLookupUtility.lookUpId(null, "Completed Without Win");
    ...
    public void testLookUpId_Connection_String_value_null() {
        try {
            SubmissionStatusLookupUtility.lookUpId(TestDataFactory.getConnection(), null);
            Assert.fail("IllegalArgumentException should have been thrown");
        } catch (IllegalArgumentException e) {
            // expected behavior
        } catch (Exception e) {
    ...
    public void testLookUpId_Connection_String_value_ZERO_LENGTH_STRING() {
        try {
            SubmissionStatusLookupUtility.lookUpId(TestDataFactory.getConnection(),
    ...
    /**
     * <p>Failure test. Tests the {@link SubmissionStatusLookupUtility#lookUpId,Connection,String} for proper behavior
    ...
    public void testLookUpId_Connection_String_SQLError() {
        ...
        try {
            SubmissionStatusLookupUtility.lookUpId(TestDataFactory.getMockConnection(), "Completed Without Win");
            Assert.fail("SQLException should have been thrown");
        } catch (SQLException e) {
            // expected behavior
        } catch (Exception e) {

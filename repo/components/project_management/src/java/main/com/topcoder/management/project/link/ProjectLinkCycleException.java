...
/**
 * <p>
 * An exception to be thrown in case there is a cycle detected in project links.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class ProjectLinkCycleException extends BaseRuntimeException {
    ...
    /**
     * <p>
     * A <code>List</code> holding the projects comprising the cycle.
     * </p>
     */
    ...
    /**
     * <p>
     * Constructs new <code>ProjectLinkCycleException</code> instance with specified list of IDs in cycle.
     * </p>
     *
     * @param cycle
     *            a <code>List</code> holding the projects comprising the cycle.
    ...
    /**
     * <p>
     * Constructs new <code>ProjectLinkCycleException</code> instance with specified description of the error.
     * </p>
     *
     * @param message
     *            a <code>String</code> providing the description of the encountered error.
     */
    ...
    /**
     * <p>
     * Constructs new <code>ProjectLinkCycleException</code> instance with specified description and original cause of
     * the error.
     * </p>
     *
     * @param message
     *            a <code>String</code> providing the description of the encountered error.
     * @param cause
     *            a <code>Throwable</code> providing the original cause of the error.
     */
    ...
    /**
     * <p>
     * Constructs new <code>ProjectLinkCycleException</code> instance with specified original cause of the error.
     * </p>
     *
     * @param cause
     *            a <code>Throwable</code> providing the original cause of the error.
    ...
    /**
     * <p>
     * Builds the textual presentation of the specified cycle in project dependencies.
     * </p>
     *
     * @param cycle
     *            a <code>List</code> holding the projects comprising the cycle.

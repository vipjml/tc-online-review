...
/**
 * <p>
 * This class contains methods to build filter instances to use in project searching. It can build filter to search for
 * project based on various criteria such as:
 * </p>
 * <ul>
 ...
 * used be the client to create search filter. The created filter is used in SearchProjects() method of ProjectManager.
 * <p>
...
public class ProjectFilterUtility {
    ...
    /**
     * Represents the alias for project type id column. It is used to build search filter for this column. This constant
     * also defined in configuration settings for search builder.
     */
    public static final String PROJECT_TYPE_ID = "ProjectTypeID";

    /**
     * Represents the alias for project type name column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_TYPE_NAME = "ProjectTypeName";

    /**
     * Represents the alias for project category id column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_CATEGORY_ID = "ProjectCategoryID";

    /**
     * Represents the alias for project category name column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_CATEGORY_NAME = "ProjectCategoryName";

    /**
     * Represents the alias for project status id column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_STATUS_ID = "ProjectStatusID";

    /**
     * Represents the alias for project status name column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_STATUS_NAME = "ProjectStatusName";

    /**
     * Represents the alias for project property name column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    public static final String PROJECT_PROPERTY_NAME = "ProjectPropertyName";

    /**
     * Represents the alias for project property value column. It is used to build search filter for this column. This
     * constant also defined in configuration settings for search builder.
     */
    ...
    /**
     * Build the filter to search for project with the given type id. Type id must be greater than zero.
     *
    ...
    /**
     * Build the filter to search for project with type id in the given type id list. Type ids must be greater than
     * zero. The content of the input list must be of Long type.
     *
     * @return the filter to search for project.
     * @param typeIds
     *            The type id list to build filter.
     * @throws IllegalArgumentException
     *             if one id in the list is less than or equals to zero or the list is null or empty or the content of
     *             the list is not of Long type.
     */
    ...
    /**
     * Build the filter to search for project with the given type name. Type name must not be null or empty string.
     *
     * @return the filter to search for project.
     * @param name
    ...
    /**
     * Build the filter to search for project with type name in the given type name list. Type names must not be null or
     * empty. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param names
     *            The type names list to build filter.
     * @throws IllegalArgumentException
     *             if one name in the list is empty string or the list is null or empty or the content of the list is
     *             not of String type.
     */
    @SuppressWarnings("deprecation")
    ...
    /**
     * Build the filter to search for project with the given category id. Category id must be greater than zero.
     *
     * @return the filter to search for project.
     * @param categoryId
    ...
    /**
     * Build the filter to search for project with category id in the given category id list. Category ids must be
    ...
    /**
     * Build the filter to search for project with the given category name. Category name must not be null or empty
     * string.
     *
     * @return the filter to search for project.
     * @param name
    ...
    /**
     * Build the filter to search for project with category name in the given category name list. Category names must
     * not be null or empty. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param names
    ...
    /**
     * Build the filter to search for project with the given status id. Status id must be greater than zero.
     *
     * @return the filter to search for project.
     * @param statusId
    ...
    /**
     * Build the filter to search for project with status id in the given status id list. Status ids must be greater
     * than zero. The content of the input list must be of Long type.
     *
     * @return the filter to search for project.
     * @param statusIds
    ...
    /**
     * Build the filter to search for project with the given status name. Status name must not be null or empty string.
     *
     * @return the filter to search for project.
     * @param name
    ...
    /**
     * Build the filter to search for project with status name in the given status name list. Status names must not be
     * null or empty. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param names
    ...
    /**
     * Build the filter to search for project with the given property name. Name must not be null or empty string.
     *
     * @return the filter to search for project.
     * @param name
    ...
    /**
     * Build the filter to search for project with the given list of property names. Names must not be null or empty
     * string. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param names
    ...
    /**
     * Build the filter to search for project with the given property value. Value must not be null or empty string.
     *
     * @return the filter to search for project.
     * @param value
    ...
    /**
     * Build the filter to search for project with the given list of property values. Values must not be null or empty
     * string. The content of the input list must be of String type.
     *
     * @return the filter to search for project.
     * @param values
     *            The property name list to build filter.
     * @throws IllegalArgumentException
     *             if one value in the list is empty string or the list is null or empty or the content of the list is
     *             not of String type.
     */
    ...
    /**
     * <p>
     * Build the filter to search for project with the given property name/value pair. Name and value must not be null
     * or empty string.
     * </p>
     *
     * @param name
    ...
    public static Filter buildProjectPropertyEqualFilter(String name, String value) {
        return buildAndFilter(buildProjectPropertyNameEqualFilter(name), buildProjectPropertyValueEqualFilter(value));
    }


    /**
     * <p>
     *  Build the filter to search for project with the given TC Direct project id. ID must be greater than zero.
     * </p>
     *
     ...
     *            the name of list
     * @throws IllegalArgumentException
     *             if one element in the list is less than or equals to zero or the list is null or empty or the content
     *             of the list is not of Long type.
     */
     ...
     *            the name of list
     * @throws IllegalArgumentException
     *             if one element in the list is empty string or the list is null or empty or the content of the list is
     *             not of String type.
     */

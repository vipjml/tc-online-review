...
public class DefaultProjectValidator implements ProjectValidator {
    ...
    /**
     * Create a new instance of DefaultProjectValidator. This class does not have any configuration settings. But the
     * namespace parameter is provided to comply with the contract defined in ScorecardValidator interface.
     *
     * @param namespace

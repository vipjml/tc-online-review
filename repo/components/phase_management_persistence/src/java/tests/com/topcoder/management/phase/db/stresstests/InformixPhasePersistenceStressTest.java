...
public class InformixPhasePersistenceStressTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        manager.add("Stress/Connection.xml");
        manager.add("Stress/SampleConfig.xml");
        ...
        try {
            ...
            stmt.execute("delete from phase_type_lu where phase_type_id in (54321, 54322, 54323)");
            stmt.execute("delete from phase_status_lu where phase_status_id in (54321, 54322, 54323)");
            stmt.execute("delete from project where project_id in (54321, 54322, 54323)");
            ...
            // create phase
            stmt.execute("insert into project_phase values (54321, 54321, 54321, 54321, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
            stmt.execute("insert into project_phase values (54322, 54322, 54322, 54322, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
            stmt.execute("insert into project_phase values (54323, 54323, 54323, 54323, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
            stmt.execute("insert into project_phase values (54324, 54321, 54323, 54323, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
            stmt.execute("insert into project_phase values (54325, 54321, 54323, 54323, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
            stmt.execute("insert into project_phase values (54326, 54322, 54323, 54323, current, "
                        + "current, current, current, current, 100, 'stress', current, "
                        + "'stress', current)");
    ...
    public void testGetProjectPhasesLongArray() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            Project[] projects = persistence.getProjectPhases(new long[] {54321, 54322, 54323});
            assertEquals("Fail to get projects.", 3, projects.length);
            assertEquals("Fail to get projects.", 3, projects[0].getAllPhases().length);
            assertEquals("Fail to get projects.", 2, projects[1].getAllPhases().length);
            assertEquals("Fail to get projects.", 1, projects[2].getAllPhases().length);
        }
        System.out.println("getProjectPhases method spends " + (System.currentTimeMillis() - start)
                    + " millisecond.");
    }
    ...
    public void testCreatePhases() throws Exception {
        ...
        System.out.println("createPhases method spends " + (System.currentTimeMillis() - start)
                    + " millisecond.");
    ...
    public void testGetPhases() throws Exception {
        long start = System.currentTimeMillis();
        for (int i = 0; i < 10; i++) {
            Phase[] phases = persistence.getPhases(new long[] {54321, 54322, 54323, 54324, 54325,
                54326});
            assertEquals("Fail to get phases.", 6, phases.length);
        }
        System.out.println("getPhases method spends " + (System.currentTimeMillis() - start)
                    + " millisecond.");
    }
    ...
    public void testUpdatePhases() throws Exception {
        Phase[] phases = persistence
                    .getPhases(new long[] {54321, 54322, 54323, 54324, 54325, 54326});
        ...
        System.out.println("updatePhases method spends " + (System.currentTimeMillis() - start)
                    + " millisecond.");
    }

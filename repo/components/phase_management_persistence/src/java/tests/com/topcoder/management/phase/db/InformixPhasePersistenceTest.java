...
/**
 * Unit tests for the {@link com.topcoder.management.phase.db.InformixPhasePersistence} class.
 *
 * @author kr00tki
 * @version 1.0
 */
public class InformixPhasePersistenceTest extends DbTestCase {
    /**
    ...
    /**
     * Sets up test test environment. Most of the work is made in base class. Here only new
     * InformixPhasePersistence is created.
     *
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor accuracy. Checks if
    ...
    public void testConstructorString() throws Exception {
        ...
        assertEquals("Incorrect connection name.", CONNECTION_NAME, getField(persistence, "connectionName"));
    }

    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * {@link IllegalArgumentException} is thrown when the <code>nnamespace</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * {@link IllegalArgumentException} is thrown when the <code>namespace</code> is empty.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - missing classname property.
     *
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - missing namespace property.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - namespace value is empty.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - classname is empty.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - empty connection name.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#InformixPhasePersistence(String)} constructor failure. Checks if
     * the {@link ConfigurationException} is thrown on config error - invalid classname.
     */
     ...
     * constructor accuracy. Checks if all internal fields are properly initialized.
     *
     * @throws Exception to JUnit.
     */
    public void testConstructorDBConnectionFactoryString() throws Exception {
        DBConnectionFactory factory = getConnectionFactory();
        persistence = new InformixPhasePersistence(factory, CONNECTION_NAME, getIDGenerator());
        assertSame("Factory not set.", factory, getField(persistence, "connectionFactory"));
        assertEquals("Name not set.", CONNECTION_NAME, getField(persistence, "connectionName"));
    }

    /**
     * Tests the
     * {@link InformixPhasePersistence#InformixPhasePersistence(DBConnectionFactory, String, IDGenerator)}
     * constructor accuracy. Checks if the <code>null</code> connectionName is allowed.
     *
     * @throws Exception to JUnit.
     */
    public void testConstructorDBConnectionFactoryString_NullName() throws Exception {
        persistence = new InformixPhasePersistence(getConnectionFactory(), null, getIDGenerator());
        assertSame("Factory not set.", getConnectionFactory(), getField(persistence, "connectionFactory"));
        assertNull("Name should be null.", getField(persistence, "connectionName"));
    }

    /**
     * Tests the
     * {@link InformixPhasePersistence#InformixPhasePersistence(DBConnectionFactory, String, IDGenerator)}
     * constructor failure. Checks if the {@link IllegalArgumentException} is thrown when the connectionFactory is
     * <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    public void testConstructorDBConnectionFactoryString_NullFactory() throws Exception {
        try {
     ...
     * Tests the
     * {@link InformixPhasePersistence#InformixPhasePersistence(DBConnectionFactory, String, IDGenerator)}
     * constructor failure. Checks if the {@link IllegalArgumentException} is thrown when the connectionName is
     * empty.
     *
     * @throws Exception to JUnit.
     */
    public void testConstructorDBConnectionFactoryString_EmptyName() throws Exception {
        try {
            new InformixPhasePersistence(getConnectionFactory(), " ", getIDGenerator());
     ...
     * @throws Exception to JUnit.
     */
    public void testConstructorDBConnectionFactoryString_NullGenerator() throws Exception {
        try {
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long)} method accuracy. Checks if correct phases
     * for each porject are retrieved.
     *
     * @throws Exception to JUnit.
     */
    public void testGetProjectPhasesLong() throws Exception {
        // create test phases and store them
        Phase[] phases = new Phase[] {createPhase(1, 1, true), createPhase(2, 1, true), createPhase(3, 2, true)};
        ...
        assertEquals("Incorrect project start date.", phases[0].getScheduledStartDate(), project.getStartDate());
        // because the order of phases is unknown we need to check all posibilities
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long)} method accuracy. Checks if null value is
     * returned when the project not exists.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long)} method accuracy. Checks if empty project
     * (without any phase) is retrieved.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long[])} method accuracy. Checks if all requested
     * Projects are returned and if the null is retured for projects that do not exists.
     *
     * @throws Exception to JUnit.
     */
    public void testGetProjectPhases() throws Exception {
        ...
        Project[] projects = persistence.getProjectPhases(new long[] {1, 2, 3, 6});
        assertEquals("Should have 4 projects", 4, projects.length);
        assertEquals("Should have 2 phases", 2, projects[0].getAllPhases().length);
        assertEquals("Should have 1 phase", 1, projects[1].getAllPhases().length);
        assertEquals("Should have 0 phases", 0, projects[2].getAllPhases().length);
        assertNull("Should be null.", projects[3]);
    }

    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long[])} method accuracy. Checks if empty array
     * is returned on empty input array.
     *
     * @throws Exception to JUnit.
     */
    public void testGetProjectPhasesLongArray_EmptyArray() throws Exception {
        assertEquals("Should return empty array", 0, persistence.getProjectPhases(new long[0]).length);
    }

    /**
     * Tests the {@link InformixPhasePersistence#getProjectPhases(long[])} method failure. Checks if
     * {@link IllegalArgumentException} is thrown when the <code>array</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getAllPhaseTypes()} method accuracy. Checks if all predefined
     * phase types are returned.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getAllPhaseStatuses()} method accuracy. Checks if all preloaded
     * phase statuses are returned.
     *
     * @throws Exception to JUnit.
     */
    public void testGetAllPhaseStatuses() throws Exception {
        ...
        assertEquals("Incorrect type name.", "phase_status_1", statuses[0].getName());

        assertEquals("Incorrect type id.", 2, statuses[1].getId());
        assertEquals("Incorrect type name.", "phase_status_2", statuses[1].getName());
        assertEquals("Incorrect type id.", 3, statuses[2].getId());
        assertEquals("Incorrect type name.", "phase_status_3", statuses[2].getName());
    }

    /**
     * Tests the {@link InformixPhasePersistence#createPhase(Phase, String)} method accuracy. Checks if the phase,
     * its depedencies and criteria are properly inserted into database.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhase(Phase, String)} method accuracy. Checks if phase is
     * created with only required field. No exception should be thrown on null optional values.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phase</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>operator</code> is null.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>operator</code> is empty.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhases(Phase[], String)} method accuracy. Checks if all the
     * phases are properly created in the database.
     *
     * @throws Exception to JUnit.
     */
    public void testCreatePhases() throws Exception {
        ...
        phases[0].addDependency(new Dependency(phases[1], phases[0], true, false, 0));
        phases[0].addDependency(new Dependency(phases[2], phases[0], true, false, 0));
        phases[1].addDependency(new Dependency(phases[3], phases[1], true, false, 0));
        phases[1].addDependency(new Dependency(phases[4], phases[1], true, false, 0));
        phases[2].addDependency(new Dependency(phases[5], phases[2], true, false, 0));
        phases[4].addDependency(new Dependency(phases[6], phases[4], true, false, 0));
        phases[5].addDependency(new Dependency(phases[6], phases[5], true, false, 0));
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhases(Phase[], String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phases</code> is null.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#createPhases(Phase[], String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phases</code> array contains null.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getPhase(long)} method accuracy. Checks if expected phase is
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getPhase(long)} method accuracy. Checks of correct phases are
     * retrieved from the database with thier depedencies and criterias.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getPhase(long)} method accuracy. Checks if null is returned when
     * the phase with given id doesn't exists.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#getPhases(long[])} method accuracy. Checks if all expected phases
     * are retireved.
     *
     * @throws Exception to JUnit.
     */
    public void testGetPhases() throws Exception {
        ...
        for (int i = 0; i < phases.length; i++) {
            phases[i] = createPhase(i, 1, i % 2 == 0);
            for (int j = 0; j < i; j++) {
                phases[i].addDependency(new Dependency(phases[j], phases[i], false, true, i));
            }
        }
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhase(Phase, String)} method accuracy. Checks if the phase
     * data are updated in the database.
     *
     * @throws Exception to JUnit.
     */
    ...
    public void testUpdatePhase_Dependencies() throws Exception {
        ...
        persistence.createPhases(new Phase[] {phase, phase1, phase2}, CREATION_USER);
        assertDatabase(phase, CREATION_USER);
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhase(Phase, String)} method accuracy. Checks if the new
     * phase will be stored in the database.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phase</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>operator</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhase(Phase, String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>operator</code> is <code>empty</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhases(Phase[], String)} method accuracy. Checks if all the
     * phases and their depedencies are updated correctly.
     *
     * @throws Exception to JUnit.
     */
    public void testUpdatePhases() throws Exception {
        ...
        phases[6].addDependency(new Dependency(phases[1], phases[6], false, false, 1));
        persistence.createPhases(phases, CREATION_USER);
        ...
        for (int i = 0; i < phases.length; i++) {
            ...
            if (i > i) {
                phases[i].addDependency(new Dependency(phases[i - 1], phases[i], false, false, 1));
            }
        }
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhases(Phase[], String)} method accuracy. Checks if all the
     * phases will be updated in the persistence.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhases(Phase[], String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phases</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#updatePhases(Phase[], String)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phases</code> contains <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    public void testUpdatePhases_NullOperator() throws Exception {
        try {
            persistence.updatePhases(new Phase[] {createPhase(1, 1, false)}, null);
            fail("Null operator, IAE expected.");
        } catch (IllegalArgumentException ex) {
            // ok
        }
    ...
    /**
     * Tests the {@link InformixPhasePersistence#deletePhase(Phase)} method accuracy. Checks if the phase and their
     * depedencies are removed from the database.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#deletePhase(Phase)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phase</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#deletePhases(Phase[])} method accuracy. Checks if all the phases,
     * depedencies and criteria are removed.
     *
     * @throws Exception to JUnit.
     */
    public void testDeletePhases() throws Exception {
        ...
        phases[0].addDependency(new Dependency(phases[1], phases[0], true, false, 0));
        phases[1].addDependency(new Dependency(phases[3], phases[1], false, false, 0));
        phases[2].addDependency(new Dependency(phases[5], phases[2], true, true, 0));
        phases[4].addDependency(new Dependency(phases[6], phases[4], true, false, 0));
    ...
    /**
     * Tests the {@link InformixPhasePersistence#deletePhases(Phase[])} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phases</code> is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#isNewPhase(Phase)} method accuracy. Checks if the phase with id =
     * 0 is clasyfied as new.
     */
    public void testIsNewPhase() {
        assertTrue("Should be new phase", persistence.isNewPhase(createPhase(0, 1, true)));
        assertFalse("Should not be new phase", persistence.isNewPhase(createPhase(1, 1, true)));
    }

    /**
     * Tests the {@link InformixPhasePersistence#isNewPhase(Phase)} method failure. Checks if the
     * {@link IllegalArgumentException} is thrown when the <code>phase</code> is <code>null</code>.
     */
    ...
    /**
     * Tests the {@link InformixPhasePersistence#isNewDependency(Dependency)} method accuracy. Checks if
     * <code>false</code> is returned if the dependency is new.
     *
     * @throws Exception to JUnit.
     */
    public void testIsNewDependency() throws Exception {
        Dependency dep = new Dependency(createPhase(1, 1, true), createPhase(1, 1, false), true, false, 0);
        assertTrue("It should be new dependency", persistence.isNewDependency(dep));
    }

    /**
     * Tests the {@link InformixPhasePersistence#isNewDependency(Dependency)} method accuracy. Checks if
     * <code>true</code> is returned if the dependency already exists.
     *
     * @throws Exception to JUnit.
     */
    public void testIsNewDependency_False() throws Exception {
        Dependency dep = new Dependency(createPhase(1, 1, true), createPhase(1, 1, false), true, false, 0);
        persistence.createPhases(new Phase[] {dep.getDependency(), dep.getDependent()}, CREATION_USER);
        dep.getDependent().addDependency(dep);

        persistence.updatePhase(dep.getDependent(), MODIFICATION_USER);

        assertFalse("It should not be new dependency", persistence.isNewDependency(dep));
    }

    /**
     * Tests the {@link InformixPhasePersistence#isNewDependency(Dependency)} method failure. Checks if
     * {@link IllegalArgumentException} is thrown when the dependency is <code>null</code>.
     *
     * @throws Exception to JUnit.
     */

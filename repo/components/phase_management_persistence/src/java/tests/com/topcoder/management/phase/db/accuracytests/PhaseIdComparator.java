...
/**
 * An implementation of <code>Comparator</code> interface used to compare <code>Phase</code>
 * with their IDs.
 * <p>
 * This class is used to test. After we retrieved some phases, we can sort them with this
 * comparator, thus the results can be checked more easily.
 * </p>
 *
 * @author mayi
 * @version 1.0
...
public class PhaseIdComparator implements Comparator {
     ...
     * @return zero if they have same id, or a negative value if o1's id is less than o2's id,
     *              and vice versa
     *

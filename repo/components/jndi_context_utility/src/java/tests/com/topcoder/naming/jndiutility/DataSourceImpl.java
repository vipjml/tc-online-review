...
/**
 * A datasource object. NOTE: This is a mock object an provides no DataSource functionality.
 * Edited in version 2.0: the created connection's toString() method will print the name of data source.
 *
 * @author preben
 * @author Charizard
 * @version 2.0
...
public class DataSourceImpl implements Referenceable, DataSource {
    ...
    /**
     * <p>Attempts to establish a connection with the data source that this <code>DataSource</code> object
     * represents.</p>
     *

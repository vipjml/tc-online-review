...
class Helper {
    ...
    /**
     * <p> This class is a wrapper for type safe getting of values from a ResultSet and setting of values to a
     ...
     * cases). </p> <p> This class contains a private constructor to make sure all implementations of this class are
     * declared inside Helper. Instances are provided to users via constants declared in Helper - so this class defines
     * some kind of 'pseudo-enum' which cannot be instantiated externally. </p>
     *
     * @author urtks
     * @version 1.1
     */
    abstract static class DataType {
         ...
         * @throws SQLException             if error occurs while working with the given ResultSet or the index does not
         ...
         *
         * @throws IllegalArgumentException if preparedStatement or value is null, or value is not an instance of the
         *                                  subclass-dependent type
         * @throws SQLException             if error occurs while working with the given preparedStatement or the index
    ...
    private static class StringType extends DataType {
         ...
         * @param value             the value to set
         *
         * @throws IllegalArgumentException if preparedStatement or value is null, or value is not an instance of String
         *                                  type
         * @throws SQLException             if error occurs while working with the given preparedStatement or the index
         *                                  does not exist in the prepared statement
         */
    ...
    private static class LongType extends DataType {
         ...
         * @param value             the value to set
         *
         * @throws IllegalArgumentException if preparedStatement or value is null, or value is not an instance of Long
         *                                  type
         * @throws SQLException             if error occurs while working with the given preparedStatement or the index
         *                                  does not exist in the prepared statement
         */
    ...
    private static class BooleanType extends DataType {
         ...
         * @param value             the value to set
         *
         * @throws IllegalArgumentException if preparedStatement or value is null, or value is not an instance of
         *                                  Boolean type
         * @throws SQLException             if error occurs while working with the given preparedStatement or the index
         *                                  does not exist in the prepared statement
         */
    ...
    private static class DateType extends DataType {
         ...
         * type. <p/> Note: UnsupportedOperationException is always thrown currently to ensure that this method won't be
         * called.
         *
         * @param preparedStatement the prepared statement from which to set the value
         * @param index             the index at which to set the value
    ...
    /**
     * <p> This method performs the given retrieval (i.e. non-DML) query on the given connection using the given query
     ...
     * also de-allocated in this method. </p> <p> Note: The given connection is not closed or committed in this method.
     * </p>
     *
     * @param connection    the connection to perform the query on
     * @param queryString   the query to be performed
     * @param argumentTypes the types of each object in queryArgs, use one of the values STRING_TYPE, LONG_TYPE or
     *                      BOOLEAN_TYPE here
     ...
     * @throws IllegalArgumentException if queryArgs is null or the length of it is different from that of
     *                                  argumentTypes
     * @throws IllegalArgumentException if columnTypes is null or contains null or the the number of columns returned is
     *                                  different from that of columnTypes
    ...
    /**
     * <p> This method performs the given DML (query on the given connection using the given query arguments and their
     * types. The update count returned from the query is then returned. </p> <p> Note: The given connection is not
     * closed or committed in this method. </p>
     *
     * @param connection    the connection to perform the query on
     * @param queryString   the query to be performed
     * @param argumentTypes the types of each object in queryArgs, use one of the values STRING_TYPE, LONG_TYPE or
     ...
     * @throws IllegalArgumentException if queryString is null or empty (trimmed)
     * @throws IllegalArgumentException if argumentTypes is null or contains null
     * @throws IllegalArgumentException if queryArgs is null or length of it is different from that of argumentTypes
    ...
    /**
     * <p> This method performs the given DML (query on the given connection using the given query arguments and their
     * types. The update count returned from the query is then returned. </p>
     *
     * @param connectionFactory the connection factory
     * @param connectionName    the connection name
     * @param queryString       the query to be performed
     ...
     *
     * @throws IllegalArgumentException if the given long array is null or contains negative or zero values.
     */
     ...
     *
     * @throws IllegalArgumentException if the given instance is null or isValidToPersist returns false.
     */

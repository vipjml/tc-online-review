...
public class DeliverableFilterBuilderTests extends TestCase {
    ...
    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the name of the
     * Deliverable.
     */
    ...
    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the phase the
     * Deliverable falls in.
     */
    private static final String PHASE_ID_FIELD_NAME = "phase_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the submission the
     * Deliverable is associated with.
     */
    private static final String SUBMISSION_ID_FIELD_NAME = "submission_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the resource id of the
     * Deliverable.
     */
    private static final String RESOURCE_ID_FIELD_NAME = "resource_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on whether the
     * Deliverable is required or not.
     */
    ...
    /**
     * Tests the behavior of createDeliverableIdFilter. Set the parameter deliverableId = 0 IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Build a Filter using createDeliverableIdFilter, Check if it returns a correct filter. If it is correct, the
     * return filter will be a EqualToFilter, and it's name and value field is set by createDeliverableIdFilter. No
    ...
    /**
     * Tests the behavior of createNameFilter. Set the parameter deliverableId = null IllegalArgumentException should be
     * thrown.
     */
    ...
    /**
     * Build a Filter using createNameFilter, Check if it returns a correct filter. If it is correct, the return filter
     * will be a EqualToFilter, and it's name and value field is set by createNameFilter. No exception should be
     * thrown.
     */
    ...
    /**
     * Tests the behavior of createPhaseIdFilter. Set the parameter deliverableId = 0 IllegalArgumentException should be
     * thrown.
     */
    ...
    /**
     * Build a Filter using createPhaseIdFilter, Check if it returns a correct filter. If it is correct, the return
     * filter will be a EqualToFilter, and it's name and value field is set by createPhaseIdFilter. No exception should
     * be thrown.
     */
    ...
    /**
     * Build a Filter using createRequiredFilter with parameter 'true'. Check if it returns a correct filter. If it is
     * correct, the return filter will be a NotFilter. NotFilter.getFilter() will return a EqualToFilter, and it's name
     * and value field is set by createRequiredFilter. No exception should be thrown.
     */
    ...
    /**
     * Build a Filter using createRequiredFilter. Check if it returns a correct filter. If it is correct, the return
     * filter will be a EqualToFilter, and it's name and value field is set by createRequiredFilter. No exception should
     * be thrown.
     */

...
public class UploadTests extends TestCase {
    ...
    /**
     * Tests the behavior of setUploadStatus. Set the uploadStatus field, see if the getUploadStatus method can get the
    ...
    /**
     * Tests the behavior of getUploadStatus. Set the uploadStatus field, see if the getUploadStatus method can get the
     * correct value. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of setUploadType. Set the uploadType field, see if the getUploadType method can get
    ...
    /**
     * Tests the behavior of getUploadType. Set the uploadType field, see if the getUploadType method can get the
     * correct value. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of setOwner. Set the owner field with 0. IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Tests the behavior of setOwner. Set the owner field, see if the getOwner method can get the correct value. No
    ...
    /**
     * Tests the behavior of getOwner. Set the owner field, see if the getOwner method can get the correct value. No
     * exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of setProject. Set the project field with 0. IllegalArgumentException should be thrown.
     */
    ...
    /**
     * Tests the behavior of setProject. Set the project field, see if the getProject method can get the correct value.
    ...
    /**
     * Tests the behavior of getProject. Set the project field, see if the getProject method can get the correct value.
     * No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of setParameter. Set the parameter field, see if the getParameter method can get the correct
    ...
    /**
     * Tests the behavior of getParameter. Set the parameter field, see if the getParameter method can get the correct
     * value. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Set the uploadType field to null, see if the isValidToPersist returns
    ...
    /**
     * Tests the behavior of isValidToPersist. Set the uploadStatus field to null, see if the isValidToPersist returns
     * false. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Do not set owner field, see if the isValidToPersist returns false. No
     * exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Do not set project field, see if the isValidToPersist returns false. No
     * exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Set the parameter field to null, see if the isValidToPersist returns
     * false. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Set uploadType.isValidToPersist() to false, see if the isValidToPersist
     * returns false. No exception should be thrown.
     */
    ...
    /**
     * Tests the behavior of isValidToPersist. Set uploadStatus.isValidToPersist() to false, see if the isValidToPersist
     * returns false. No exception should be thrown.
     */

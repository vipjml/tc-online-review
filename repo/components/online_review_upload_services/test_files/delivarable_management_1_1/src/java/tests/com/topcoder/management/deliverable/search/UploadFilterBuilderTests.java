...
public class UploadFilterBuilderTests extends TestCase {
    ...
    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the type id of the
     * Upload.
     */
    private static final String UPLOAD_TYPE_ID_FIELD_NAME = "upload_type_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the status id of the
     * Upload.
     */
    private static final String UPLOAD_STATUS_ID_FIELD_NAME = "upload_status_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the project the Upload
     * is associated with.
     */
    private static final String PROJECT_ID_FIELD_NAME = "project_id";

    /**
     * The name of the field under which SearchBuilder Filters can be built in order to filter on the resource the
    ...
    /**
     * Tests the behavior of createUploadIdFilter. Set the parameter deliverableId = 0.
    ...
    /**
     * Tests the behavior of createUploadTypeIdFilter. Set the parameter deliverableId = 0 IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Build a Filter using createUploadTypeIdFilter, Check if it returns a correct filter. If it is correct, the return
     * filter will be a EqualToFilter, and it's name and value field is set by createUploadTypeIdFilter. No exception
     * should be thrown.
     */
    ...
    /**
     * Tests the behavior of createUploadStatusIdFilter. Set the parameter deliverableId = 0 IllegalArgumentException
     * should be thrown.
     */
    ...
    /**
     * Build a Filter using createUploadStatusIdFilter, Check if it returns a correct filter. If it is correct, the
     * return filter will be a EqualToFilter, and it's name and value field is set by createUploadStatusIdFilter. No

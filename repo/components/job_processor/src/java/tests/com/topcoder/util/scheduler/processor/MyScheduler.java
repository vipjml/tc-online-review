...
/**
 * Mock implementation of Scheduler, providing the function to get the dependent jobs for a job and retrieve all
 * job.
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class MyScheduler implements Scheduler {
     ...
     *
     * @throws SchedulingException Not implemented.
     */
     ...
     *
     * @throws SchedulingException ignore this
     */

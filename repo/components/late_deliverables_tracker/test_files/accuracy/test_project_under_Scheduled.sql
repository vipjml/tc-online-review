...
-- status = 1 means that the project is still under scheduled;
insert into project_phase(project_phase_id, project_id, phase_type_id, phase_status_id,scheduled_start_time, scheduled_end_time, duration, create_user, create_date, modify_user, modify_date)values (112, 1, 4, 1, '2010-09-12 00:22:50.312', '2010-09-13 00:22:50.312', 86400000, 'user', '2010-09-12 00:22:50.312', 'user', '2010-09-13 00:22:50.312');

package com.topcoder.util.datavalidator;
    ...
    * implementation of the abstract FloatValidator class. Note that this will
    * wrap around any type of a validator but since this is an internal class
    * only FloatValidator class is expected.
    * This is an inner class to FloatValidator.
    * It is thread-safe as it is immutable.
    * @version 1.1
    */
   class FloatValidatorWrapper extends FloatValidator {
       ...
       */
       ...
       /**
        * Creates a new <code>FloatValidatorWrapper</code> that uses
        ...
        * Creates a new <code>FloatValidatorWrapper</code> that uses
        * <code>validator</code> as the underlying
        * <code>ObjectValidator</code> and initializes the validator with a

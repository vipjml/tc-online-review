 ...
 * implementation of the abstract LongValidator class. Note that this will
 * wrap around any type of a validator but since this is an internal class
 * only LongValidator class is expected.
 * This is an inner class to LongValidator.
 * It is thread-safe as it is immutable.
 * @version 1.1
 */
  class LongValidatorWrapper extends LongValidator {
    ...
    /**
     * Creates a new <code>LongValidatorWrapper</code> that uses

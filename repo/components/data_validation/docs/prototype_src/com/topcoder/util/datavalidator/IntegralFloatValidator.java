package com.topcoder.util.datavalidator;
    ...
    /**
     * This is an extention of the FloatValidator which specifically deals with
     * validating that float values are actually converibtible to integers
     * without loss of precision (or with accpetable epsilon loss of precision)
     ...
     * This is an inner class to FloatValidator.
     * This class is thread-safe as it is immutable.
     * @version 1.1
     */
    class IntegralFloatValidator extends FloatValidator {

        /**
         * Creates a new <code>IntegralFloatValidator</code> that checks whether
        ...
        /**
         * Creates a new <code>IntegralFloatValidator</code>  and initializes

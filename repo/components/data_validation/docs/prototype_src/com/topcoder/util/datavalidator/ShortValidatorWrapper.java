package com.topcoder.util.datavalidator;
     ...
     * implementation of the abstract ShortValidator class. Note that this will
     * wrap around any type of a validator but since this is an internal class
     * only ShortValidator class is expected.
     * This is an inner class to ShortValidator.
     * It is thread-safe as it is immutable.
     * @version 1.1
     */
    class ShortValidatorWrapper extends ShortValidator {
        ...
        */
        ...
        /**
         * Creates a new <code>ShortValidatorWrapper</code> that uses

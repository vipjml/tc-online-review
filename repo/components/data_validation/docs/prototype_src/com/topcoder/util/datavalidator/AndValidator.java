 ...
 * boolean AND outcome of all the associated validators. This is basically a
 * composite AND validator. by default it warks ina short-circuited mode which
 * means that the validator will return an 'invalid' result the moment the
 * first of the validators returns a false (or null for getMessage())
...
public class AndValidator extends AbstractAssociativeObjectValidator {
    ...
    /**
     * Creates a new <code>AndValidator</code>, with initially no associated
     * validators.
     */
    public AndValidator() {
    }
    ...
    /**
     * Creates a new <code>AndValidator</code>, with 2 initial
     ...
     * validators is empty, this returns true.
     *

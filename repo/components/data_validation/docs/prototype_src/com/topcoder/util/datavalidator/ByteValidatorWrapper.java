package com.topcoder.util.datavalidator;
     ...
     * implementation of the abstract ByteValidator class. Note that this will
     * wrap around any type of a validator but since this is an internal class
     * only ByteValidator class is expected.
     * This is an inner class to ByteValidator.
     * It is thread-safe as it is immutable.
     * @version 1.1
     */
    class ByteValidatorWrapper extends ByteValidator {
        ...
        /**
         * Creates a new <code>ByteValidatorWrapper</code> that uses

package com.topcoder.util.datavalidator;
    ...
    /**
     * This is an extention of the LongValidator which specifically deals with
     ...
     * with a parity of odd (true) which would then accept only long integers
     * that are odd.
     * This is an inner class to LongValidator.
     * This class is thread-safe as it is immutable.
     * @version 1.1
     */
    class ParityLongValidator extends LongValidator {
        ...
        */
        ...
        /**
         * Creates a new <code>ParityLongValidator</code> that checks whether

package com.topcoder.util.datavalidator;
     ...
     * validating strings based on testing that strings end with a specific
     * string. As an example, if we create an instance of this validator set
     * with a string of "world" then any user input that would end with this
     * string (case-insensitive) would be considered valid.
     * This is an inner class to StringValidator.
     * This class is thread-safe as it is immutable.
     * @version 1.1
     */
    class EndsWithStringValidator extends StringValidator {

       /** Inputs must end with this string. This is initialized in the
        ...
        */
        ...
        /**
         * Creates a new <code>EndsWithStringValidator</code> that checks
         * whether inputs end with <code>str</code>.
         *

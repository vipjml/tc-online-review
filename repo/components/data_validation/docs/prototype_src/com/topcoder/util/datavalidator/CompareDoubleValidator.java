package com.topcoder.util.datavalidator;
     ...
     * @version 1.1
     */
    class CompareDoubleValidator extends DoubleValidator {
        ...
        */
        ...
        /**
         * Creates a new <code>CompareDoubleValidator</code> that compares
         ...
         */
        public CompareDoubleValidator(double value,
         ...
         * Creates a new <code>CompareDoubleValidator</code> that compares
         * inputs to <code>value</code>, in the direction determined by
         * <code>direction</code> and with a specified resource bundle
         * information.
         ...
         */
        public CompareDoubleValidator(double value,
                                      CompareDirection direction, BundleInfo bundleInfo) {
          super(bundleInfo);
          this.value = value;
          this.direction = direction;
        }

package com.topcoder.util.datavalidator;
     ...
     * with a range of 2.5f - 7.88f with an epsilon of 1e-12 then a number like
     * 5.0 would be in range and even a number like 7.88000000045 would be in
     * range but a number like 7.89f would not be valid.
     * This is an inner class to FloatValidator.
     * This class is thread-safe as it is immutable.
     * @version 1.1
     */
    class RangeFloatValidator extends FloatValidator {
       ...
       */
        ...
        */
        ...
        /**
         * Creates a new <code>RangeFloatValidator</code> that creates a range

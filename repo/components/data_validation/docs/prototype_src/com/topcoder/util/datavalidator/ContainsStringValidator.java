package com.topcoder.util.datavalidator;
     ...
     * validating strings based on substring containment. This means that we
     * will be validatng user input as bing valid it is contains the string that
     * this validator has been initialized with. As an example, if we create an
     * instance of this validator set with a string of "hello" then any user
     * input that would contain this string (case-insensitive) would be
     * considered valid.
     * This is an inner class to StringValidator.
     * This class is thread-safe as it is immutable.
     * @version 1.1
     */
    class ContainsStringValidator extends StringValidator {

        /** Inputs must contain this as a substring. This is initialized in the
        ...
        /**
         * Creates a new <code>ContainsStringValidator</code> that checks
         * whether inputs contain <code>str</code>.
         *
        ...
        /**
         * Creates a new <code>ContainsStringValidator</code> that checks
         * whether inputs contain <code>str</code> and initializes the validator

 ...
 * @version 1.1
 */
public class GreaterThanOrEqualToShortValidatorTestCases extends AbstractShortValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        shortValidator = ShortValidator.greaterThanOrEqualTo((short) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ShortValidator.greaterThanOrEqualTo((short) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ShortValidator.greaterThanOrEqualTo((short) 100, bundleInfo);
    }
}

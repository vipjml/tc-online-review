 ...
 * @version 1.1
 */
public class IsPositiveFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.isPositive(bundleInfo);
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.isPositive();
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.isPositive(bundleInfo);
    }
}

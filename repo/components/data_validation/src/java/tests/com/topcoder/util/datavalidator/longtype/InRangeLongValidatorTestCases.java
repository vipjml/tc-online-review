 ...
 * @version 1.1
 */
public class InRangeLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.inRange(100, 200, bundleInfo);
        longValidator = LongValidator.inRange(100, 200);
    }
    ...
    public void testValid_Object_Accuracy4() {
        assertTrue("Test accuracy for method valid() failed.", longValidator.valid("200"));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.inRange(100, 200);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.inRange(100, 200, bundleInfo);
    }
}

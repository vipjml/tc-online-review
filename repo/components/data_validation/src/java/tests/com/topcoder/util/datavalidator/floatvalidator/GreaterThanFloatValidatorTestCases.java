 ...
 * @version 1.1
 */
public class GreaterThanFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not greater than 100.463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.greaterThan((float) 100.463, bundleInfo);
        floatValidator = FloatValidator.greaterThan((float) 100.463);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.greaterThan((float) 100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.greaterThan((float) 100.2532463, bundleInfo);
    }
}

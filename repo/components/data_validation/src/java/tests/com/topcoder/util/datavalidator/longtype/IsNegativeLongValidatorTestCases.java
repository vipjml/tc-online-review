 ...
 * @version 1.1
 */
public class IsNegativeLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.isNegative(bundleInfo);
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.isNegative();
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.isNegative(bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class IsPositiveDoubleValidatorTestCases extends AbstractDoubleValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not greater than 0.0";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        doubleValidator = DoubleValidator.isPositive(bundleInfo);
    ...
    public AbstractObjectValidator createObjectValidator() {
        return DoubleValidator.isPositive();
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return DoubleValidator.isPositive(bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class RegexpStringValidatorTestCases extends AbstractStringValidatorTestCases {
    /**
     * <p>
     * Represents the error message.
     * </p>
     */
    private static final String ERROR_MESSAGE = "does not match the following regular expression \"top[ABC]coder\"";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        validator = StringValidator.matchesRegexp("top[ABC]coder");
    }
    ...
    public void testGetMessage_Object_Accuracy1() {
        ...
        assertEquals("Test accuracy for method getMessage() failed.", ERROR_MESSAGE,
            validator.getMessage("  toqcooder "));
        assertNull("Test accuracy for method getMessage() failed.", validator.getMessage("topAcoder"));
    }
    ...
    public void testValid_Object_Accuracy1() {
        ...
        assertTrue("Test accuracy for method getMessage() failed.", validator.valid("topAcoder"));
    }
    ...
    public void testGetAllMessages_Object_Accuracy2() {
        String[] msg = validator.getAllMessages("topAcoder");
    ...
    public void testGetAllMessages_ObjectInt_Accuracy2() {
        String[] msg = validator.getAllMessages("topAcoder", 1);
        assertNull("Test accuracy for method getAllMessages() failed.", msg);
    }
    ...
    public void testGetAllMessages_ObjectInt_failure() {
        try {
            validator.getAllMessages("topAcoder", 0);
    ...
    public AbstractObjectValidator createObjectValidator() {
        return StringValidator.matchesRegexp("top[ABC]coder");
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return StringValidator.matchesRegexp("top[ABC]coder", bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class InRangeIntegerValidatorTestCases extends AbstractIntegerValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        ...
        integerValidator = IntegerValidator.inRange(100, 200);
    }
    ...
    public void testConstructor() {
        try {
            IntegerValidator.inRange(20, 10);
    ...
    public void testValid_Object_Accuracy4() {
        assertTrue("Test accuracy for method valid() failed.", integerValidator.valid("200"));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return IntegerValidator.inRange(100, 200);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return IntegerValidator.inRange(100, 200, bundleInfo);
    }
}

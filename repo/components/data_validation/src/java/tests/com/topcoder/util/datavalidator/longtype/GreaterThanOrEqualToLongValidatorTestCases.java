 ...
 * @version 1.1
 */
public class GreaterThanOrEqualToLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.greaterThanOrEqualTo(100, bundleInfo);
        longValidator = LongValidator.greaterThanOrEqualTo(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.greaterThanOrEqualTo(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.greaterThanOrEqualTo(100, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class GreaterThanOrEqualToByteValidatorTestCases extends AbstractByteValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not greater than or equal to 100";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        byteValidator = ByteValidator.greaterThanOrEqualTo((byte) 100, bundleInfo);
        byteValidator = ByteValidator.greaterThanOrEqualTo((byte) 100);
    }
    ...
    public void testValid_Object_Accuracy2() {
        assertTrue("Test accuracy for method valid() failed.", byteValidator.valid("101"));
    }
    ...
    public void testValid_int_Accuracy2() {
        assertTrue("Test accuracy for method valid() failed.", byteValidator.valid((byte) 101));
    }
    ...
    public void testGetAllMessages_ObjectInt_Accuracy2() {
        String[] msg = byteValidator.getAllMessages("101", 1);
        assertNull("Test accuracy for method getAllMessages() failed.", msg);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ByteValidator.greaterThanOrEqualTo((byte) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ByteValidator.greaterThanOrEqualTo((byte) 100, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class GreaterThanByteValidatorTestCases extends AbstractByteValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        byteValidator = ByteValidator.greaterThan((byte) 100, bundleInfo);
        byteValidator = ByteValidator.greaterThan((byte) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ByteValidator.greaterThan((byte) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ByteValidator.greaterThan((byte) 100, bundleInfo);
    }
}

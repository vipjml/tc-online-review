 ...
 * @version 1.1
 */
public class GreaterThanIntegerValidatorTestCases extends AbstractIntegerValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        integerValidator = IntegerValidator.greaterThan(100, bundleInfo);
        integerValidator = IntegerValidator.greaterThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return IntegerValidator.greaterThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return IntegerValidator.greaterThan(100, bundleInfo);
    }
}

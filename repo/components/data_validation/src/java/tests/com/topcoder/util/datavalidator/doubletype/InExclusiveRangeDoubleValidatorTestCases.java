 ...
 * @version 1.1
 */
public class InExclusiveRangeDoubleValidatorTestCases extends AbstractDoubleValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String DOWN_ERROR_MESSAGE = "not greater than 100.2532463";
     ...
     * </p>
     */
    private static final String UP_ERROR_MESSAGE = "not less than 200.54267";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        doubleValidator = DoubleValidator.inExclusiveRange(100.2532463, 200.54267, bundleInfo);
        doubleValidator = DoubleValidator.inExclusiveRange(100.2532463, 200.54267);
    }
    ...
    public void testConstructor_failure1() {
        try {
            DoubleValidator.inExclusiveRange(20, 10);
    ...
    public void testConstructor_failure2() {
        try {
            DoubleValidator.inExclusiveRange(20, 20);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be unsuccessful when the number is equal to 200.54267.
     * </p>
     */
    ...
    public void testValid_Object_Accuracy4() {
        assertFalse("Test accuracy for method valid() failed.", doubleValidator.valid("200.54267"));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return DoubleValidator.inExclusiveRange(100.2532463, 200.54267);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return DoubleValidator.inExclusiveRange(100.2532463, 200.54267, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class LessThanOrEqualToFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not less than or equal to 100.463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.lessThanOrEqualTo((float) 100.463, bundleInfo);
        floatValidator = FloatValidator.lessThanOrEqualTo((float) 100.463);
    }
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful when the number is lessthan 100.463.
     * </p>
     */
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.lessThanOrEqualTo((float) 100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.lessThanOrEqualTo((float) 100.2532463, bundleInfo);
    }
}

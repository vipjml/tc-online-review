 ...
 * @version 1.1
 */
public class EqualToFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not equal to 100.463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.equalTo((float) 100.463, bundleInfo);
        floatValidator = FloatValidator.equalTo((float) 100.463);
    }
     ...
     * The result should be unsuccessful when the number is not equal to 100.463.
     * </p>
     */
    public void testGetMessage_Object_Accuracy1() {
        String msg = floatValidator.getMessage("1023.342");
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful only when the number is 100.463.
     * </p>
     */
    ...
    public void testGetMessage_int_Accuracy1() {
        String msg = floatValidator.getMessage((float) 1023.342);
        assertEquals("Test accuracy for method getMessage() failed.", ERROR_MESSAGE, msg);
    }
    ...
    public void testValid_Object_Accuracy1() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid("1023.342"));
    }

    /**
     * <p>
     * Accuracy test case for method 'valid()'.<br> The result should be successful only when the number is 100.463.
     * </p>
     */
    ...
    public void testValid_int_Accuracy1() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid((float) 1023.342));
    }
    ...
    public void testGetMessages_Object_Accuracy1() {
        String[] msg = floatValidator.getMessages("1023.342");
    ...
    public void testGetAllMessages_Object_Accuracy1() {
        String[] msg = floatValidator.getAllMessages("1023.342");
    ...
    public void testGetAllMessages_ObjectInt_Accuracy1() {
        String[] msg = floatValidator.getAllMessages("1023.342", 2);
        assertEquals("Test accuracy for method getAllMessages() failed.", 1, msg.length);
        assertEquals("Test accuracy for method getAllMessages() failed.", ERROR_MESSAGE, msg[0]);
    }
    ...
    public void testGetAllMessages_ObjectInt_Accuracy2() {
        String[] msg = floatValidator.getAllMessages("100.463", 1);
        assertNull("Test accuracy for method getAllMessages() failed.", msg);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.equalTo((float) 100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.equalTo((float) 100.2532463, bundleInfo);
    }
}

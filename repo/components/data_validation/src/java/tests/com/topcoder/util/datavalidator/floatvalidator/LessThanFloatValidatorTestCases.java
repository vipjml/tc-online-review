 ...
 * @version 1.1
 */
public class LessThanFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not less than 100.463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.lessThan((float) 100.463, bundleInfo);
        floatValidator = FloatValidator.lessThan((float) 100.463);
    }
     ...
     * The result should be unsuccessful when the number is greater than 100.463.
     * </p>
     */
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful when the number is less than 100.463.
     * </p>
     */
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.lessThan((float) 100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.lessThan((float) 100.2532463, bundleInfo);
    }
}

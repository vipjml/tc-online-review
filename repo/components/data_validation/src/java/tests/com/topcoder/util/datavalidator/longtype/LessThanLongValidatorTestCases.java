 ...
 * @version 1.1
 */
public class LessThanLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.lessThan(100, bundleInfo);
        longValidator = LongValidator.lessThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.lessThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.lessThan(100, bundleInfo);
    }
}

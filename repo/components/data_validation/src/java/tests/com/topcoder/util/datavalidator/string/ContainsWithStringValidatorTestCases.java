 ...
 * @version 1.1
 */
public class ContainsWithStringValidatorTestCases extends AbstractStringValidatorTestCases {
    /**
     * <p>
     * Represents the error message.
     * </p>
     */
    private static final String ERROR_MESSAGE = "does not contain \"cod\"";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        validator = StringValidator.containsSubstring("cod");
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return StringValidator.containsSubstring("top");
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return StringValidator.containsSubstring("top", bundleInfo);
    }
}

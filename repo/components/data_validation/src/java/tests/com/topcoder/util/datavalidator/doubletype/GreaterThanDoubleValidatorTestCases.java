 ...
 * @version 1.1
 */
public class GreaterThanDoubleValidatorTestCases extends AbstractDoubleValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not greater than 100.2532463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        doubleValidator = DoubleValidator.greaterThan(100.2532463, bundleInfo);
        doubleValidator = DoubleValidator.greaterThan(100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return DoubleValidator.greaterThan(100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return DoubleValidator.greaterThan(100.2532463, bundleInfo);
    }
}

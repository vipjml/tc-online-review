 ...
 * @version 1.1
 */
public class LessThanIntegerValidatorTestCases extends AbstractIntegerValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        integerValidator = IntegerValidator.lessThan(100, bundleInfo);
        integerValidator = IntegerValidator.lessThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return IntegerValidator.lessThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return IntegerValidator.lessThan(100, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class InRangeByteValidatorTestCases extends AbstractByteValidatorTestCases {
    /**
     * <p>
     ...
     * </p>
     */
    private static final String UP_ERROR_MESSAGE = "not less than or equal to 119";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        byteValidator = ByteValidator.inRange((byte) 100, (byte) 119, bundleInfo);
        byteValidator = ByteValidator.inRange((byte) 100, (byte) 119);
    }
    ...
    public void testConstructor() {
        try {
            ByteValidator.inRange((byte) 20, (byte) 10);
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful when the number is equal to 119.
     * </p>
     */
    ...
    public void testValid_Object_Accuracy4() {
        assertTrue("Test accuracy for method valid() failed.", byteValidator.valid("119"));
    }
    ...
    public void testValid_int_Accuracy4() {
        assertTrue("Test accuracy for method valid() failed.", byteValidator.valid((byte) 119));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ByteValidator.inRange((byte) 100, (byte) 119);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ByteValidator.inRange((byte) 100, (byte) 119, bundleInfo);
    }
}

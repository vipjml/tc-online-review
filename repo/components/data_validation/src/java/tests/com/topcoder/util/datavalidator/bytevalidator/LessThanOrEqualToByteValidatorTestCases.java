 ...
 * @version 1.1
 */
public class LessThanOrEqualToByteValidatorTestCases extends AbstractByteValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        byteValidator = ByteValidator.lessThanOrEqualTo((byte) 100, bundleInfo);
        byteValidator = ByteValidator.lessThanOrEqualTo((byte) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ByteValidator.lessThanOrEqualTo((byte) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ByteValidator.lessThanOrEqualTo((byte) 100, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class InExclusiveRangeShortValidatorTestCases extends AbstractShortValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        shortValidator = ShortValidator.inExclusiveRange((short) 100, (short) 200);
    }
    ...
    public void testConstructor_failure1() {
        try {
            ShortValidator.inExclusiveRange((short) 20, (short) 10);
    ...
    public void testConstructor_failure2() {
        try {
            ShortValidator.inExclusiveRange((short) 20, (short) 20);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testValid_Object_Accuracy4() {
        assertFalse("Test accuracy for method valid() failed.", shortValidator.valid("200"));
    }
    ...
    public void testValid_int_Accuracy4() {
        assertFalse("Test accuracy for method valid() failed.", shortValidator.valid((short) 200));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ShortValidator.inExclusiveRange((short) 100, (short) 200);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ShortValidator.inExclusiveRange((short) 100, (short) 200, bundleInfo);
    }
}

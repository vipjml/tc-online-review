 ...
 * @version 1.1
 */
public class GreaterThanLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.greaterThan(100, bundleInfo);
        longValidator = LongValidator.greaterThan(100);
    }
    ...
    /**
     * <p>
     * Accuracy test case for method 'valid()'.<br> The result should be unsuccessful when the number is equal than 100.
     * </p>
     */
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.greaterThan(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.greaterThan(100, bundleInfo);
    }
}

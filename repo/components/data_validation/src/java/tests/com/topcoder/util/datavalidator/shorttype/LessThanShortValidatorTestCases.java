 ...
 * @version 1.1
 */
public class LessThanShortValidatorTestCases extends AbstractShortValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        shortValidator = ShortValidator.lessThan((short) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return ShortValidator.lessThan((short) 100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return ShortValidator.lessThan((short) 100, bundleInfo);
    }
}

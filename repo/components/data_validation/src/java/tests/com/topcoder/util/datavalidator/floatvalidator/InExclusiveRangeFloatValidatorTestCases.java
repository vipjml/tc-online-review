 ...
 * @version 1.1
 */
public class InExclusiveRangeFloatValidatorTestCases extends AbstractFloatValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String DOWN_ERROR_MESSAGE = "not greater than 100.463";
     ...
     * </p>
     */
    private static final String UP_ERROR_MESSAGE = "not less than 200.267";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        floatValidator = FloatValidator.inExclusiveRange((float) 100.463, (float) 200.267, bundleInfo);
        floatValidator = FloatValidator.inExclusiveRange((float) 100.463, (float) 200.267);
    }
    ...
    public void testConstructor_failure1() {
        try {
            FloatValidator.inExclusiveRange(20, 10);
    ...
    public void testConstructor_failure2() {
        try {
            FloatValidator.inExclusiveRange(20, 20);
            fail("IllegalArgumentException should be thrown.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be unsuccessful when the number is equal to 100.463.
     * </p>
     */
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be unsuccessful when the number is equal to 200.267.
     * </p>
     */
    ...
    public void testValid_Object_Accuracy3() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid("100.463"));
    }
    ...
    public void testValid_Object_Accuracy4() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid("200.267"));
    }
    ...
    public void testValid_int_Accuracy3() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid((float) 100.463));
    }
    ...
    public void testValid_int_Accuracy4() {
        assertFalse("Test accuracy for method valid() failed.", floatValidator.valid((float) 200.267));
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return FloatValidator.inExclusiveRange((float) 100.2532463, (float) 200.267);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return FloatValidator.inExclusiveRange((float) 100.2532463, (float) 200.267, bundleInfo);
    }
}

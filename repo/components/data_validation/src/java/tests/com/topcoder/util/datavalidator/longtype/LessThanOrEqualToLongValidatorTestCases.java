 ...
 * @version 1.1
 */
public class LessThanOrEqualToLongValidatorTestCases extends AbstractLongValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        longValidator = LongValidator.lessThanOrEqualTo(100, bundleInfo);
        longValidator = LongValidator.lessThanOrEqualTo(100);
    }
    ...
    public void testValid_Object_Accuracy1() {
        assertFalse("Test accuracy for method valid() failed.", longValidator.valid("101"));
    }
    ...
    public void testValid_Object_Accuracy2() {
        assertTrue("Test accuracy for method valid() failed.", longValidator.valid("99"));
    }
    ...
    public void testValid_Object_Accuracy3() {
        assertTrue("Test accuracy for method valid() failed.", longValidator.valid("100"));
    }
    ...
    public void testGetAllMessages_ObjectInt_Accuracy1() {
        String[] msg = longValidator.getAllMessages("101", 2);
        assertEquals("Test accuracy for method getAllMessages() failed.", 1, msg.length);
        assertEquals("Test accuracy for method getAllMessages() failed.", ERROR_MESSAGE, msg[0]);
    }
    ...
    public void testGetAllMessages_ObjectInt_Accuracy2() {
        String[] msg = longValidator.getAllMessages("99", 1);
        assertNull("Test accuracy for method getAllMessages() failed.", msg);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return LongValidator.lessThanOrEqualTo(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return LongValidator.lessThanOrEqualTo(100, bundleInfo);
    }
}

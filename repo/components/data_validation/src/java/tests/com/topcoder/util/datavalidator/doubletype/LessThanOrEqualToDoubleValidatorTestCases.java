 ...
 * @version 1.1
 */
public class LessThanOrEqualToDoubleValidatorTestCases extends AbstractDoubleValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not less than or equal to 100.2532463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        doubleValidator = DoubleValidator.lessThanOrEqualTo(100.2532463, bundleInfo);
        doubleValidator = DoubleValidator.lessThanOrEqualTo(100.2532463);
    }
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful when the number is lessthan 100.2532463.
     * </p>
     */
    ...
    public AbstractObjectValidator createObjectValidator() {
        return DoubleValidator.lessThanOrEqualTo(100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return DoubleValidator.lessThanOrEqualTo(100.2532463, bundleInfo);
    }
}

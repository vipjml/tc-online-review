 ...
 * @version 1.1
 */
public class GreaterThanOrEqualToIntegerValidatorTestCases extends AbstractIntegerValidatorTestCases {
    /**
     * <p>
    ...
    protected void setUp() throws Exception {
        super.setUp();
        integerValidator = IntegerValidator.greaterThanOrEqualTo(100, bundleInfo);
        integerValidator = IntegerValidator.greaterThanOrEqualTo(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return IntegerValidator.greaterThanOrEqualTo(100);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return IntegerValidator.greaterThanOrEqualTo(100, bundleInfo);
    }
}

 ...
 * @version 1.1
 */
public class GreaterThanOrEqualToDoubleValidatorTestCases extends AbstractDoubleValidatorTestCases {
    /**
     * <p>
     * A <code>String</code> represents the error message when the validation fails.
     * </p>
     */
    private static final String ERROR_MESSAGE = "not greater than or equal to 100.2532463";
    ...
    protected void setUp() throws Exception {
        super.setUp();
        doubleValidator = DoubleValidator.greaterThanOrEqualTo(100.2532463, bundleInfo);
        doubleValidator = DoubleValidator.greaterThanOrEqualTo(100.2532463);
    }
     ...
     * <p>
     * Accuracy test case for method 'getMessage()'.<br>
     * The result should be successful when the number is greater than 100.2532463.
     * </p>
     */
    ...
    public void testValid_Object_Accuracy2() {
        assertTrue("Test accuracy for method valid() failed.", doubleValidator.valid("100.2532464"));
    }
    ...
    public void testGetAllMessages_ObjectInt_Accuracy2() {
        String[] msg = doubleValidator.getAllMessages("100.2532464", 1);
        assertNull("Test accuracy for method getAllMessages() failed.", msg);
    }
    ...
    public AbstractObjectValidator createObjectValidator() {
        return DoubleValidator.greaterThanOrEqualTo(100.2532463);
    }
    ...
    public AbstractObjectValidator createObjectValidator(BundleInfo bundleInfo) {
        return DoubleValidator.greaterThanOrEqualTo(100.2532463, bundleInfo);
    }
}

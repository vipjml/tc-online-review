...
public class ResourceRoleTest extends TestCase {
    ...
    /**
     * Tests method: ResourceRole(long).
     *
    ...
    /**
     * Tests method: ResourceRole(long, String, long).
     *
     * With non-positive id, IllegalArgumentException should be thrown.
     */
     ...
     * Tests method: ResourceRole(long, String, long).
     *
     * With non-positive phaseType, IllegalArgumentException should be thrown.
     */
    ...
    public void testSetDescription_NotNull() {
        ...
        assertEquals("The method does not work properly when the parameter is null.",
                "Description", rr1.getDescription());
    }
    ...
    /**
     * Tests method setPhaseTypeType(Long).
     *
     * Sets it with null.
     */
    ...
    /**
     * Tests method setPhaseType(Long).
     *
    ...
    /**
     * Tests method getPhaseType(Long).
     *
     * Sets it with a normal value.
     */

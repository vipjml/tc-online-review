...
public class Scorecard extends NamedScorecardStructure {
    ...
    public void setCategory(long category) {
        Util.checkNotNonPositive(category, "category");
    ...
    public void setMinScore(float minScore) {
        if (Float.isNaN(minScore) || Float.isInfinite(minScore)) {
            throw new IllegalArgumentException("The minimum score must be a real, non-infinite number.");
        }

        if (!Float.isNaN(maxScore) && (minScore > maxScore)) {
            throw new IllegalStateException("The minimum score cannot be greater than the maximum score.");
        }
    ...
    public void setMaxScore(float maxScore) {
        if (Float.isNaN(maxScore) || Float.isInfinite(maxScore)) {
            throw new IllegalArgumentException("The maximum score must be a real, non-infinite number.");
        }

        if (!Float.isNaN(minScore) && (maxScore < minScore)) {
            throw new IllegalStateException("The maximum score cannot be less than the minimum score.");
        }

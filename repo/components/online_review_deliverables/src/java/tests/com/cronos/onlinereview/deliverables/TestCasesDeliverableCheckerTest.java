...
/**
 * <p>
 * Unit tests for the {@link com.cronos.onlinereview.deliverables.TestCasesDeliverableChecker} class.
 * </p>
 *
 * @author kr00tki
 * @version 1.0
 */
public class TestCasesDeliverableCheckerTest extends DbTestCase {

    /**
     * The TestCasesDeliverableChecker instance to test on.
     */
    private TestCasesDeliverableChecker checker = null;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        checker = new TestCasesDeliverableChecker(getConnectionFactory(), CONNECTION_NAME);
    }

    /**
     * <p>
     * Tests the {@link TestCasesDeliverableChecker#TestCasesDeliverableChecker(DBConnectionFactory)} constructor
    ...
    public void testConstructor_Factory() throws Exception {
        checker = new TestCasesDeliverableChecker(getConnectionFactory());
    ...
    /**
     * <p>
     * Tests the {@link TestCasesDeliverableChecker#TestCasesDeliverableChecker(DBConnectionFactory, String)}
    ...
    public void testConstructor_FactoryString_NullName() throws Exception {
        checker = new TestCasesDeliverableChecker(getConnectionFactory(), null);
        assertSame("Incorrect connection factory.", getConnectionFactory(), getFieldFromBaseClass(checker,
                "connectionFactory"));
        assertNull("Name should be null.", getFieldFromBaseClass(checker, "connectionName"));
    }
    ...
    public void testConstructor_FactoryString_NullFactory() {
        try {
            new TestCasesDeliverableChecker(null, CONNECTION_NAME);
            fail("Null connection factor, IAE expected.");
        } catch (IllegalArgumentException ex) {
            // ok
        }
    ...
    public void testConstructor_FactoryString_EmptyName() throws Exception {
        try {
            new TestCasesDeliverableChecker(getConnectionFactory(), " ");
    ...
    /**
     * Tests the {@link TestCasesDeliverableChecker#fillInQueryParameters(Deliverable, PreparedStatement)} method
    ...
    /**
     * Tests the {@link TestCasesDeliverableChecker#getSqlQuery()} method. Checks if it returns non-null and
    ...
    public void testCheck() throws Exception {
        createUpload(10, TEST_CASE_TYPE, ACTIVE, 1, 1);
        createUpload(11, TEST_CASE_TYPE, INACTIVE, 1, 1);
        Deliverable deliverable = new Deliverable(1, 1, 1, new Long(1), true);
        checker.check(deliverable);
        assertNotNull("It should be completed.", deliverable.getCompletionDate());
    }
     ...
     * @throws Exception to JUnit.
     */
    public void testCheck_UploadInactive() throws Exception {
        createUpload(10, TEST_CASE_TYPE, INACTIVE, 1, 1);
        Deliverable deliverable = new Deliverable(1, 1, 1, new Long(1), true);
        checker.check(deliverable);
        assertNull("It not should be completed.", deliverable.getCompletionDate());
    }
     ...
     * @throws Exception to JUnit.
     */
    public void testCheck_NoTestCase() throws Exception {
        createUpload(10, FINAL_FIX_TYPE, INACTIVE, 1, 1);
        Deliverable deliverable = new Deliverable(1, 1, 1, new Long(1), true);
        checker.check(deliverable);
        assertNull("It not should be completed.", deliverable.getCompletionDate());
    }
     ...
     * @throws Exception to JUnit.
     */
    public void testCheck_UploadNoResource() throws Exception {
        createUpload(10, FINAL_FIX_TYPE, INACTIVE, 1, 1);
        Deliverable deliverable = new Deliverable(1, 1, 3, new Long(1), true);
        checker.check(deliverable);
        assertNull("It not should be completed.", deliverable.getCompletionDate());
    }
    ...
    public void testCheck_NoProject() throws Exception {
        createUpload(10, FINAL_FIX_TYPE, INACTIVE, 1, 1);
        Deliverable deliverable = new Deliverable(10, 1, 1, new Long(1), true);
        checker.check(deliverable);
        assertNull("It not should be completed.", deliverable.getCompletionDate());
    }

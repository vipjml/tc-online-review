...
/**
 * <p>
 * Unit tests for the {@link com.cronos.onlinereview.deliverables.FinalFixesDeliverableChecker} class.
 * </p>
 *
 * @author kr00tki
 * @version 1.0
 */
public class FinalFixesDeliverableCheckerTest extends DbTestCase {

    /**
     * The FinalFixesDeliverableChecker instance to test on.
     */
    private FinalFixesDeliverableChecker checker = null;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        checker = new FinalFixesDeliverableChecker(getConnectionFactory(), CONNECTION_NAME);
    }

    /**
     * <p>
     * Tests the {@link FinalFixesDeliverableChecker#FinalFixesDeliverableChecker(DBConnectionFactory)} constructor
    ...
    public void testConstructor_Factory() throws Exception {
        checker = new FinalFixesDeliverableChecker(getConnectionFactory());
    ...
    /**
     * <p>
     * Tests the {@link FinalFixesDeliverableChecker#FinalFixesDeliverableChecker(DBConnectionFactory, String)}
    ...
    public void testConstructor_FactoryString_NullName() throws Exception {
        checker = new FinalFixesDeliverableChecker(getConnectionFactory(), null);
        assertSame("Incorrect connection factory.", getConnectionFactory(), getFieldFromBaseClass(checker,
                "connectionFactory"));
        assertNull("Name should be null.", getFieldFromBaseClass(checker, "connectionName"));
    }
    ...
    public void testConstructor_FactoryString_NullFactory() {
        try {
            new FinalFixesDeliverableChecker(null, CONNECTION_NAME);
            fail("Null connection factor, IAE expected.");
        } catch (IllegalArgumentException ex) {
            // ok
        }
    ...
    public void testConstructor_FactoryString_EmptyName() throws Exception {
        try {
            new FinalFixesDeliverableChecker(getConnectionFactory(), " ");
    ...
    /**
     * Tests the {@link FinalFixesDeliverableChecker#fillInQueryParameters(Deliverable, PreparedStatement)} method
    ...
    /**
     * Tests the {@link FinalFixesDeliverableChecker#getSqlQuery()} method. Checks if it returns non-null and
    ...
    /**
     * Tests the {@link FinalFixesDeliverableChecker#check(Deliverable)} method accuracy.
     *
     * @throws Exception to JUnit.
     */
    public void testCheck_Active() throws Exception {
        createUpload(10, FINAL_FIX_TYPE, ACTIVE, 1, 2);
    ...
    public void testCheck_Inactive() throws Exception {
        createUpload(10, FINAL_FIX_TYPE, INACTIVE, 1, 2);
        Deliverable deliverable = new Deliverable(1, 1, 2, null, true);
        checker.check(deliverable);
     ...
     * @throws Exception to JUnit.
     */
    public void testCheck_NoFinalFixUpload() throws Exception {
    ...
    /**
     * <p>
     * Tests the {@link FinalFixesDeliverableChecker#check(Deliverable)} method failure. Checks if

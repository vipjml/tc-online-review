...
public class ConverterUtilityTests extends TestCase {
    ...
    private static final String BAD_CONFIG_FILE = "test_files" + File.separator + "bad_config"
        + File.separator + "Xml_Phase_Template_Persistence_Bad_Config.xml";
     ...
     * </p>
     * <p>
     * It test with "-auto" enabled. It use DBPhaseTemplatePersistence to generate the phases from the
     * database to verify that the entries are inserted correctly. And it also read some other field of the
     * template to verify the results are correct.
     * </p>
     *
     * @throws Exception
     *             to JUnit
    ...
    public void testMainAutoEnabled() throws Exception {
        ...
        DBPhaseTemplatePersistence persistence = new DBPhaseTemplatePersistence(
            TestHelper.getDBConnectionFactory(), "test");
        ...
        assertEquals("Description Incorrect", "This is a design phases template",
            persistence.getTemplateDescription("New_Design"));
        assertEquals("Description Incorrect", "This is a development phases template",
            persistence.getTemplateDescription("New_Development"));
    ...
    public void testMainBadConnection() throws Exception {
        ...
        TestHelper.initializeDBWithNoEntry();
        ConverterUtility.main(new String[]{"-inamespace", NEW_XML_NAMESPACE, "-onamespace",
            "ConnectionException"});
    }
    ...
    public void testMainEmptyTemplateName() throws Exception {
        ...
        TestHelper.initializeDBWithNoEntry();
        ConverterUtility
            .main(new String[]{"-inamespace", "empty_template_name", "-onamespace", DB_NAMESPACE});
    }
     ...
     * </p>
     * <p>
     * It calls the main method when there already entries in the database. No error message should show. It
     * also use the default connection name.
     * </p>
     *
     * @throws Exception
     *             to JUnit
    ...
    public void testMainDefault() throws Exception {
        ...
        DBPhaseTemplatePersistence persistence = new DBPhaseTemplatePersistence(
            TestHelper.getDBConnectionFactory(), "test");
        assertEquals("The default template name is not correct.", "New_Design_Default",
     ...
     * </p>
     * <p>
     * This test case is almost the same as the case testMainAutoEnabled, execept that "-ifile" argument is
     * used here. The configuration manager should load the config from the given file automatically.
     * </p>
     *
     * @throws Exception
     *             to JUnit

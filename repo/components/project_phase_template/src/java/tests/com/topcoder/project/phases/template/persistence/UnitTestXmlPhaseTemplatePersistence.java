...
public class UnitTestXmlPhaseTemplatePersistence extends TestCase {
     ...
     * </p>
     */
    private static final String TEMPLATE_FILE_EMPTY_NAME = "test_files/bad_template/BadTemplate_EmptyName.xml";
     ...
     * </p>
     */
    private static final String BAD_CONFIG_FILE = "test_files/bad_config/Xml_Phase_Template_Persistence_Bad_Config.xml";
     ...
     * </p>
     */
    private static final String CONFIG_NAMESPACE = "com.topcoder.project.phases.template.persistence.XmlPhaseTemplatePersistence";
    ...
    public void setUp() throws Exception {
        ...
        this.persistence2 = new XmlPhaseTemplatePersistence(new String[]{TEMPLATE_FILE_DESIGN,
            TEMPLATE_FILE_DEVELOPMENT});
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for accuracy.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with null
     * namespace, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with empty
     * namespace, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws ConfigurationException
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with unknown
     * namespace, <code>ConfigurationException</code> is expected.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has no files, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has empty filename, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has nonexist filename, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has malformed file, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has invalid file, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String namespace)</code> for failure with bad
     * config in which "template_files" property has template which has an empty name,
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with null
     * fileNames, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with empty
     * array of fileNames, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    /**
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some element is null, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some element is empty, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some file doesn't exist, <code>PersistenceException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some file is malformed xml, <code>PersistenceException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some file is invalid persistence file, <code>PersistenceException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>XmlPhaseTemplatePersistence(String[] fileNames)</code> for failure with invalid
     * fileNames in which some template file is with empty name, <code>PersistenceException</code> is
     * expected.
     * </p>
     */
    ...
    public void testGeneratePhases_NullTemplateName() throws PhaseGenerationException, PersistenceException {
        ...
        try {
            this.persistence1.generatePhases(null, project, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException ex) {
            // expected
        }
    ...
    public void testGeneratePhases_EmptyTemplateName() throws PhaseGenerationException, PersistenceException {
        ...
        try {
            this.persistence1.generatePhases("  ", project, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException ex) {
            // expected
        }
    ...
    public void testGeneratePhases_UnknownTemplateName() throws PhaseGenerationException,
        ...
        try {
            this.persistence1.generatePhases("unknown", project, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException ex) {
            // expected
        }
     ...
     * <p>
     * Tests method <code>generatePhases(String templateName, Project project)</code> for failure with null
     * project, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    public void testGeneratePhases_NullProject() throws PhaseGenerationException, PersistenceException {
        ...
        try {
            this.persistence1.generatePhases(TEMPLATE_DESIGN, null, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException ex) {
            // expected
        }
    ...
    /**
     * <p>
     * Tests method <code>generatePhases(String templateName, Project project)</code> for failure. Some phase
     * is associated with unknown phase type, <code>PhaseGenerationException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    public void testGeneratePhases_UnknownPhaseTypeInTemplate() throws PersistenceException {
        ...
        try {
            this.persistence2.generatePhases(TEMPLATE_UNKNOWN_PHASE_TYPE, project, null);
     ...
     * <p>
     * Tests method <code>generatePhases(String templateName, Project project)</code> for failure. Some phase
     * dependents on unknown phase, <code>PhaseGenerationException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    public void testGeneratePhases_UnknownPhaseInTemplate() throws PersistenceException {
        ...
        try {
            this.persistence2.generatePhases(TEMPLATE_UNKNOWN_PHASE, project, null);
            fail("PhaseGenerationException expected.");
        } catch (PhaseGenerationException ex) {
            // expected
        }
    ...
    public void testGeneratePhases_Success() throws PhaseGenerationException, PersistenceException {
        ...
        // generate phases
        this.persistence1.generatePhases(TEMPLATE_DESIGN, project, null);
    ...
    /**
     * <p>
     * Tests method <code>getAllTemplateNames()</code> for accuracy. Here the persistence is created from
     * configuration.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests method <code>getAllTemplateNames()</code> for accuracy. Here the persistence is created from API.
     * </p>
     */

...
public class UnitTestDefaultPhaseTemplate extends TestCase {
    ...
    /**
     * <p>
     * Configuration namespace for <code>DefaultPhaseTemplate</code>, in which the persistence and start date
     * generator are both configured to be created from default constructors of dummy implementations. It will
     * be used in test case <code>testCtor1_Success2()</code>.
     * </p>
     */
     ...
     * </p>
     */
    private static final String TEMPLATE_FILE_UNKNOWN_PHASE_TYPE = "test_files/bad_template/BadTemplate_UnknownPhaseType.xml";
     ...
     * </p>
     */
    private static final String TEMPLATE_FILE_UNKNOWN_PHASE = "test_files/bad_template/BadTemplate_UnknownPhase.xml";
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for accuracy.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for accuracy. The persistence and
     * start date generator instances will be created via default constructor.
     * </p>
     *
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with null namespace,
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with empty namespace,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws ConfigurationException
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "persistence" property is missing, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "persistence.class" property is missing, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "persistence.class" property is unknown, <code>ConfigurationException</code> is
     * expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "persistence.namespace" property is unknown for
     * <code>XmlPhaseTemplatePersistence</code>, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "persistence.namespace" property is missing for
     * <code>XmlPhaseTemplatePersistence</code>, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "start_date_generator" property is missing, <code>ConfigurationException</code>
     * is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "start_date_generator.class" property is missing,
     * <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "start_date_generator.class" property is unknown,
     * <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "start_date_generator.namespace" property is unknown for
     * <code>RelativeWeekTimeStartDateGenerator</code>, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "start_date_generator.namespace" property is missing for
     * <code>XmlPhaseTemplatePersistence</code>, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "workdays" property is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "workdays.object_specification_namespace" property is missing,
     * <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "workdays.object_key" property is missing, <code>ConfigurationException</code>
     * is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "workdays.object_specification_namespace" property is unknown,
     * <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(String namespace)</code> for failure with bad
     * configuration in which "workdays.object_identifier" property is unknown,
     * <code>ConfigurationException</code> is expected.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(PhaseTemplatePersistence persistence,
     * StartDateGenerator startDateGenerator, Workdays workdays)</code> for failure with null persistence,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(PhaseTemplatePersistence persistence,
     * StartDateGenerator startDateGenerator, Workdays workdays)</code> for failure with null
     * startDateGenerator, <code>IllegalArgumentException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(PhaseTemplatePersistence persistence,
     * StartDateGenerator startDateGenerator, Workdays workdays)</code> for failure with null workdays,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Tests constructor <code>DefaultPhaseTemplate(PhaseTemplatePersistence persistence,
     * StartDateGenerator startDateGenerator, Workdays workdays)</code> for accuracy.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName)</code> for failure with null templateName,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName)</code> for failure with empty templateName,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PhaseTemplateException
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName)</code> for failure with unknown templateName,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PhaseTemplateException
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName)</code> for failure. Some phase is associated with
     * unknown phase type, <code>PhaseGenerationException</code> is expected.
     * </p>
     *
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName)</code> for failure. Some phase depends on unknown
     * phase, <code>PhaseGenerationException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName, Date startDate)</code> for failure with null
     ...
     * <p>
     * Tests method <code>applyTemplate(String templateName, Date startDate)</code> for failure with null
     * startDate, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PhaseTemplateException
     *             to JUnit
    ...
    public void testApplyTemplate2_NullStartDate() throws PhaseTemplateException {
        ...
        try {
            template.applyTemplate(TEMPLATE_DESIGN, null, null);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException ex) {
            // expected
        }
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName, Date startDate)</code> for failure with empty
     * templateName, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PhaseTemplateException
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName, Date startDate)</code> for failure with unknown
     * templateName, <code>IllegalArgumentException</code> is expected.
     * </p>
     *
     * @throws PhaseTemplateException
    ...
    /**
     * <p>
     * Tests method <code>applyTemplate(String templateName, Date startDate)</code> for failure. Some phase
     * depends on unknown phase, <code>PhaseGenerationException</code> is expected.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    /**
     * <p>
     * Tests method <code>setPersistence(PhaseTemplatePersistence persistence)</code> for failure with null
     * persistence, <code>IllegalArgumentException</code> is expected.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests method <code>setPersistence(PhaseTemplatePersistence persistence)</code> for accuracy.
     * </p>
     *
     * @throws PersistenceException
     *             to JUnit
    ...
    /**
     * <p>
     * Tests method <code>setStartDateGenerator(StartDateGenerator startDateGenerator)</code> for failure with
     * null startDateGenerator, <code>IllegalArgumentException</code> is expected.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests method <code>setStartDateGenerator(StartDateGenerator startDateGenerator)</code> for accuracy.
     * </p>
     */
    ...
    /**
     * <p>
     * Tests method <code>setWorkdays(Workdays workdays)</code> for failure with null workdays,
     * <code>IllegalArgumentException</code> is expected.
     * </p>
     */

...
public class DummyPhaseTemplatePersistence implements PhaseTemplatePersistence {
    ...
    /**
     * <p>
     * Generates an array of Phases from the template with the given name and add them into the given Project
     * object.The dependency hierarchy will be generated too.
     * </p>
     *
     * @param templateName
     *            the template name

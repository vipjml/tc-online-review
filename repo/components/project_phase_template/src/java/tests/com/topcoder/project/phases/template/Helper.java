...
public final class Helper {
    ...
    /**
     * <p>
     * Check the given phases against the sample phases, the sample phases are defined in
     * test_files/template/TCSTemplate_Design.xml.
     * </p>
     *
     * @param phases
     *            the phases to check
    ...
    public static void checkSamplePhases(Phase[] phases) {
        ...
        for (int i = 0; i < phases.length; i++) {
            ...
            case 2:
                ...
                Assert.assertEquals("Incorrect dependency.", "Submission", dependency.getDependency().getPhaseType()
                    .getName());
            ...
            case 3:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Screening", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 4:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Review", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 5:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Appeals", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 6:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Appeals Response", dependency.getDependency()
            ...
            case 7:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Aggregation", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 8:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Aggregation Review", dependency.getDependency()
                    .getPhaseType().getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 9:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Final Fixes", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
            case 10:
                ...
                Assert.assertEquals("Incorrect lag time.", 0, dependency.getLagTime());
                Assert.assertEquals("Incorrect dependent.", phase, dependency.getDependent());
                Assert.assertEquals("Incorrect dependency.", "Final Review", dependency.getDependency().getPhaseType()
                    .getName());
                Assert.assertFalse("Incorrect isDependencyStart.", dependency.isDependencyStart());
                Assert.assertTrue("Incorrect isDependentStart.", dependency.isDependentStart());
                break;
    ...
    /**
     * <p>
     * Check the generated start date against the default configuration: 9:00 AM next Thursday.
     * </p>
     *
     * @param date
     *            the date to check
    ...
    /**
     * Assert the phase all dependencies.
     *
     * @param projects
     *            the project
     * @param phaseId
     ...
     *            the dependencies
     */
    public static void assertDependencies(Project projects, long phaseId, Long... dependencies) {

        if (dependencies == null) {
            dependencies = new Long[]{};
        }
        List<Long> result = new ArrayList<Long>();
        for (Long lon : dependencies) {
            result.add(lon);
        }

        List<Long> numList = new ArrayList<Long>();
        for (Phase phase : projects.getAllPhases()) {
            for (Dependency dep : phase.getAllDependencies()) {
                if (dep.getDependent().getId() == phaseId) {
                    numList.add(dep.getDependency().getId());
                }
            }
        }
        numList.removeAll(result);
        Assert.assertEquals("The array contains the expected dependencies", 0, numList.size());
    }

...
public final class TestHelper {
    ...
    /**
     * <p>
     * Represent the jdbc driver name. Its value can be configured in "test_files\testconfig.xml".
     * </p>
     */
    ...
    /**
     * <p>
     * Represent the name of the INFORMIXSERVER. Its value can be configured in "test_files\testconfig.xml".
     * </p>
     */
     ...
     * </p>
     */
    private static final String TEST_CONFIG_FILE = "test_files" + File.separator + "testconfig.xml";
    ...
    /**
     * <p>
     * Static code block to initialize those constants from "test_files\testconfig.xml" using Configuration
     * API.
     * </p>
     */
    static {
        ...
        try {
            ConfigurationObject configObject = xmlFilePersistence.loadFile("test",
                new File(TestHelper.TEST_CONFIG_FILE)).getChild("testconfig");
    ...
    /**
     * <p>
     * Helper method to get the instance of DBConnectionFactory for testing use. If the inner factory is null,
     * a new instance would be initialized.
     * </p>
     *
    ...
    /**
     * <p>
     * Helper method to initialize the database for test use. It create a database with the name "tcmodule",
     * create some tables, and add some entries using the sql script.
     * </p>
     *
     * @throws Exception
     *             to JUnit
    ...
    public static void initializeDB() throws Exception {
        ...
        if (createtablesql == null) {
            ...
            for (int i = 0; i < tableName.length; ++i) {
                createtablesql[i] = getSQLScript("test_files" + File.separator + "sqlscript" + File.separator
                    + tableName[i] + ".sql");
            }
        }
        ...
        // add some entries
        statement.execute(getSQLScript("test_files" + File.separator + "sqlscript" + File.separator + "addentry.sql"));
     ...
     * <p>
     * Helper method to initialize the database for test use. It create a database with the name "tcmodule",
     * create the requred table tables. No entries would be added.
     * </p>
     *
     * @throws Exception
     *             to JUnit

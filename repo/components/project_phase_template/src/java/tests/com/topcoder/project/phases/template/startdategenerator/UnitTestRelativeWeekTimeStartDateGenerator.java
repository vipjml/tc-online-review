...
public class UnitTestRelativeWeekTimeStartDateGenerator extends TestCase {
     ...
     * </p>
     */
    private static final String BAD_CONFIG = "test_files/bad_config/Relative_Week_Time_Start_Date_Generator_Bad_Config.xml";
    ...
    public void setUp() throws Exception {
        ...
        this.generator1 = new RelativeWeekTimeStartDateGenerator(DAY_OF_WEEK, HOUR, MINUTE, SECOND, WEEK_OFFSET);
    ...
    /**
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * namespace is unknown, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "week_offset" is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "week_offset" is malformed, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "day_of_week" is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "day_of_week" is malformed, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "day_of_week" is less than 1, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "day_of_week" is larger than 7, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "hour" is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "hour" is malformed, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "hour" is less than 0, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "hour" is larger than 23, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "minute" is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "minute" is malformed, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "minute" is less than 0, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "minute" is larger than 59, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "second" is missing, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "second" is malformed, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "second" is less than 0, <code>ConfigurationException</code> is expected.
     * </p>
     */
     ...
     * <p>
     * Test constructor <code>RelativeWeekTimeStartDateGenerator(String namespace)</code> for failure. The
     * "second" is larger than 59, <code>ConfigurationException</code> is expected.
     * </p>
     */
    ...
    /**
     * <p>
     * Test on method <code>generateStartDate()</code> for accuracy. According to the configuration, 9:00 AM
     * next Thursday should be generated.
     * </p>
     *

...
public class DefaultPhaseTemplateAccuracyTests extends TestCase {
    /**
     * <p>Represents the <code>DefaultPhaseTemplate</code> instance used in tests.</p>
     */
    ...
    /**
     * Accuracy test for the applyTemplate(String,long[]) method test.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     *
     * @since 1.2
     */
    public void testApplyTemplate3Accuracy() throws Exception {
        Project project = defaultPhaseTemplate.applyTemplate("FireIce", new long[] { 1, 2, 3 });
        assertNotNull(project);
        assertNotNull(project.getAllPhases());
        assertEquals("incorrect phase number.", 5, project.getAllPhases().length);

        project = defaultPhaseTemplate.applyTemplate("tester");
        assertEquals("incorrect phase number.", 6, project.getAllPhases().length);
    }

    /**
     * Accuracy test for the applyTemplate(String,long[],Date) method test.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     *
     * @since 1.2
     */
    public void testApplyTemplate4Accuracy() throws Exception {
        Project project = defaultPhaseTemplate.applyTemplate("FireIce", new long[] { 1, 2, 3 }, new Date());
        assertNotNull(project);
        assertNotNull(project.getAllPhases());
        assertEquals("incorrect phase number.", 5, project.getAllPhases().length);
    ...
    /**
     * Accuracy test for the applyTemplate(String,long[],long, long, Date) method test.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     *
     * @since 1.2
     */
    public void testApplyTemplate5Accuracy() throws Exception {
        Project project = defaultPhaseTemplate.applyTemplate("FireIce", new long[] { 1, 2, 3 }, 4, 5, new Date());
        assertNotNull(project);
        assertNotNull(project.getAllPhases());
        assertEquals("incorrect phase number.", 5, project.getAllPhases().length);
    ...
    /**
     * Accuracy test for the applyTemplate(String,long[],long, long, Date, Date) method test.
     *
     * @throws Exception pass any unexpected exception to JUnit.
     *
     * @since 1.2
     */
    public void testApplyTemplate6Accuracy() throws Exception {
        try {
            Calendar cal = Calendar.getInstance();
            cal.set(2009, 10, 12);
            defaultPhaseTemplate.applyTemplate("FireIce", new long[] { 1, 2, 3 }, 4, 5, new Date(), cal.getTime());
            fail("the phases couldn't be fixed");
    ...
    public void testSetWorkdaysAccuracy() throws Exception {
        Workdays workdays = new DefaultWorkdays("accuracytests/workdays.xml", "XML");
    ...
    protected void setUp() throws Exception {
        ...
        configManager.add("accuracytests/WorkdaysObjectFactoryConfig.xml");
        configManager.add("accuracytests/DefaultPhaseTemplate.xml");
        defaultPhaseTemplate = new DefaultPhaseTemplate(new MockPhaseTemplatePersistence(),
                new MockStartDateGenerator(), new DefaultWorkdays("accuracytests/workdays.xml", "XML"));
    }
    ...
    /**
     * <p>Test inheritance.</p>
     *  <p><code>DefaultPhaseTemplate</code> should implement the <code>PhaseTemplate</code> interface.</p>
     */

...
/**
 * <p>A test case for {@link ReviewAssignmentNotificationException} class.</p>
 *
 * @author isv
 * @version 1.0
 */
public class ReviewAssignmentNotificationExceptionAccuracyTest {

    /**
     * <p>A <code>ReviewAssignmentNotificationException</code> instance to run the test against.</p>
     */
    private ReviewAssignmentNotificationException testedInstance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(ReviewAssignmentNotificationExceptionAccuracyTest.class);
    }
    ...
    /**
     * <p>Tests the {@link ReviewAssignmentNotificationException#ReviewAssignmentNotificationException(String)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String() {
        String message = TestDataFactory.getExceptionMessage();
        this.testedInstance = new ReviewAssignmentNotificationException(message);
    ...
    /**
     * <p>Tests the
     * {@link ReviewAssignmentNotificationException#ReviewAssignmentNotificationException(String, Throwable)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String_Throwable() {
        ...
        this.testedInstance = new ReviewAssignmentNotificationException(message, cause);
    ...
    /**
     * <p>Tests the
     * {@link ReviewAssignmentNotificationException#ReviewAssignmentNotificationException(String, ExceptionData)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String_ExceptionData() {
        ...
        this.testedInstance = new ReviewAssignmentNotificationException(message, data);
    ...
    public void testConstructor_String_Throwable_ExceptionData() {
        ...
        Throwable cause = TestDataFactory.getExceptionCause();
        ExceptionData data = TestDataFactory.getExceptionData();
        this.testedInstance = new ReviewAssignmentNotificationException(message, cause, data);

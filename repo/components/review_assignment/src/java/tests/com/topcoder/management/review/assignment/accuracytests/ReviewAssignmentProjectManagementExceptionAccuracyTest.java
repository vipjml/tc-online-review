...
/**
 * <p>A test case for {@link ReviewAssignmentProjectManagementException} class.</p>
 *
 * @author isv
 * @version 1.0
 */
public class ReviewAssignmentProjectManagementExceptionAccuracyTest {

    /**
     * <p>A <code>ReviewAssignmentProjectManagementException</code> instance to run the test against.</p>
     */
    private ReviewAssignmentProjectManagementException testedInstance;
    ...
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(ReviewAssignmentProjectManagementExceptionAccuracyTest.class);
    }
    ...
    /**
     * <p>Tests the {@link ReviewAssignmentProjectManagementException#ReviewAssignmentProjectManagementException(String)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String() {
        String message = TestDataFactory.getExceptionMessage();
        this.testedInstance = new ReviewAssignmentProjectManagementException(message);
    ...
    /**
     * <p>Tests the
     * {@link ReviewAssignmentProjectManagementException#ReviewAssignmentProjectManagementException(String, Throwable)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String_Throwable() {
        ...
        this.testedInstance = new ReviewAssignmentProjectManagementException(message, cause);
    ...
    /**
     * <p>Tests the
     * {@link ReviewAssignmentProjectManagementException#ReviewAssignmentProjectManagementException(String, 
     * ExceptionData)}
     * constructor for accuracy.</p>
     */
    @Test
    public void testConstructor_String_ExceptionData() {
        ...
        this.testedInstance = new ReviewAssignmentProjectManagementException(message, data);
    ...
    public void testConstructor_String_Throwable_ExceptionData() {
        ...
        Throwable cause = TestDataFactory.getExceptionCause();
        ExceptionData data = TestDataFactory.getExceptionData();
        this.testedInstance = new ReviewAssignmentProjectManagementException(message, cause, data);

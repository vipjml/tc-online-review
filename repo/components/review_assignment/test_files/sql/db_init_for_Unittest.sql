...
CREATE SEQUENCE 'informix'.resource_id_seq;
CREATE SEQUENCE 'informix'.resource_role_id_seq;
CREATE SEQUENCE 'informix'.notification_type_id_seq;
CREATE SEQUENCE 'informix'.phase_id_seq;
CREATE SEQUENCE 'informix'.project_id_seq;
CREATE SEQUENCE 'informix'.project_user_audit_seq;
CREATE SEQUENCE 'informix'.file_type_id_seq;
CREATE SEQUENCE 'informix'.prize_id_seq;
CREATE SEQUENCE 'informix'.studio_spec_id_seq;
CREATE SEQUENCE 'informix'.project_phase_id_seq;
...
INSERT INTO id_sequences(name, next_block_start, block_size, exhausted) VALUES('project_phase_id_seq', 1000, 20, 0);
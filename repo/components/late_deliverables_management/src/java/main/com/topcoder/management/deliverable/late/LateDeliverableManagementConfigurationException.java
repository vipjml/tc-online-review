 ...
 * error occurs while initializing an instance using the given configuration.
 * </p>
 *
 * <p>
...
public class LateDeliverableManagementConfigurationException extends BaseRuntimeException {
     ...
     */
    public LateDeliverableManagementConfigurationException(String message) {
        super(message);
    }
     ...
     */
    public LateDeliverableManagementConfigurationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public LateDeliverableManagementConfigurationException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            will be automatically used instead.
     */
    public LateDeliverableManagementConfigurationException(String message, Throwable cause, ExceptionData data) {

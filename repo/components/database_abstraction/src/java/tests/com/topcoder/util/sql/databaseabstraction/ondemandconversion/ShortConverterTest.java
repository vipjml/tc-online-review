...
public class ShortConverterTest extends TestCase {
    ...
    /**
     * Instance of Short used in this unit test case as value parameter.
     */
    private static final Short TEST_VALUE = new Short((short) 2);

    /**
     * Instance of ShortConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:ShortConverter can be instantiated correctly.
     * </p>
     */
    public void testShortConverter() {
        assertNotNull("Unable to instantiate ShortConverter.", converter);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Short, false is returned.
     * </p>
     */
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Short.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Short, IllegalMappingException is thrown.
     * </p>
     */
    ...
    public void testConvert15() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(TEST_VALUE.shortValue()));
    }

...
public class IntConverterTest extends TestCase {
    ...
    /**
     * Instance of Integer used in this unit test case as value parameter.
     */
    private static final Integer TEST_VALUE = new Integer(2);

    /**
     * Instance of IntConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:IntConverter can be instantiated correctly.
     * </p>
     */
    public void testIntConverter() {
        assertNotNull("Unable to instantiate IntConverter.", converter);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Integer, false is returned.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Integer, false is returned.
     * </p>
     */
    public void testCanConvert11() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Integer.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Integer, IllegalMappingException is thrown.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Integer, IllegalMappingException is thrown.
     * </p>
     *
     * @throws Exception
     *             exception to JUnit.
    ...
    public void testConvert11() throws Exception {
        try {
            converter.convert(TEST_VALUE, 1, TEST_CRSMD, Integer.class);
            fail("IllegalMappingException expected.");
        } catch (IllegalMappingException e) {
            // good
        }
    ...
    public void testConvert15() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(TEST_VALUE.intValue()));
    }

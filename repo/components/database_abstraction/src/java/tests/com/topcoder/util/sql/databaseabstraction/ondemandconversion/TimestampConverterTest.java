...
/**
 * Test case for TimestampConverter.
 *
 * @author justforplay
 * @version 1.1
 * @since 1.1
...
public class TimestampConverterTest extends TestCase {
    ...
    /**
     * Instance of Timestamp used in this unit test case as value parameter.
     */
    private static final Timestamp TEST_VALUE = new Timestamp(100000);

    /**
     * Instance of TimestampConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:TimestampConverter can be instantiated correctly.
     * </p>
     */
    public void testTimestampConverter() {
        assertNotNull("Unable to instantiate TimestampConverter.", converter);
    }

    /**
     * <p>
     * Test TimestampConverter(DateFormat dateFormat) {.
     * </p>
     * <p>
     * Verify:when dateFormat is null, IllegalArgumentException is thrown.
     * </p>
     */
    public void testTimestampConverter2() {
        try {
    ...
    public void testCanConvert3() {
        try {
            converter.canConvert(TEST_VALUE, 0, TEST_CRSMD, Date.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testCanConvert4() {
        try {
            converter.canConvert(TEST_VALUE, -1, TEST_CRSMD, Date.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testCanConvert5() {
        try {
            converter.canConvert(TEST_VALUE, TEST_CRSMD.getColumnCount() + 1, TEST_CRSMD, Date.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Timestamp, true is returned.
     * </p>
     */
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.",
                converter.canConvert(new String("Wrong Type"), 1, TEST_CRSMD, Date.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Date, true is returned.
     * </p>
     */
    public void testCanConvert10() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Date.class), true);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Timestamp, false is returned.
     * </p>
     */
    public void testCanConvert11() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Timestamp.class),
                false);
    }
    ...
    public void testConvert6() {
        try {
            converter.convert(null, 1, TEST_CRSMD, Date.class);
     ...
     * </p>
     * <p>
     * Verify:When value is not a Timestamp, IllegalMappingException is thrown.
     * </p>
     */
    public void testConvert7() {
        try {
            converter.convert(new String("Wrong Type"), 1, TEST_CRSMD, Date.class);
            fail("IllegalMappingException expected");
        } catch (IllegalMappingException e) {
            // good
        }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Timestamp, IllegalMappingException is thrown.
     * </p>
     */
    public void testConvert8() {
        try {
            converter.convert(TEST_VALUE, 1, TEST_CRSMD, Timestamp.class);
            fail("IllegalMappingException expected");
        } catch (IllegalMappingException e) {
            // good
        }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Date, returned value is correct.
     * </p>
     *
     * @throws Exception
     *             exception to JUnit.
    ...
    public void testConvert9() throws Exception {
        Object obj = converter.convert(TEST_VALUE, 1, TEST_CRSMD, Date.class);
        assertTrue("convert is incorrect.", obj instanceof Date);
        assertEquals("convert is incorrect.", obj, new Date(TEST_VALUE.getTime()));
    }
    ...
    public void testConvert14() throws Exception {
        ...
        TimestampConverter converter2 = new TimestampConverter(formatter);

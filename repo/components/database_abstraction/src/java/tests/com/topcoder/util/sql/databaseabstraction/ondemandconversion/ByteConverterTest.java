...
public class ByteConverterTest extends TestCase {
     ...
     */
    private static final Byte TEST_VALUE = new Byte((byte) 2);

    /**
     * Instance of ByteConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:ByteConverter can be instantiated correctly.
     * </p>
     */
    public void testByteConverter() {
        assertNotNull("Unable to instantiate ByteConverter.", converter);
    }
    ...
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.",
                converter.canConvert(new String("Not BigDecimal"), 1, TEST_CRSMD, Double.class), false);
    }
    ...
    public void testConvert3() {
        try {
            converter.canConvert(TEST_VALUE, 0, TEST_CRSMD, Double.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testConvert4() {
        try {
            converter.canConvert(TEST_VALUE, -1, TEST_CRSMD, Double.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testConvert5() {
        try {
            converter.canConvert(TEST_VALUE, TEST_CRSMD.getColumnCount() + 1, TEST_CRSMD, Double.class);
            fail("IllegalArgumentException expected.");
        } catch (IllegalArgumentException e) {
            // good
        }
    ...
    public void testConvert6() {
        try {
            converter.convert(null, 1, TEST_CRSMD, Double.class);
    ...
    public void testConvert7() {
        try {
            converter.convert(new String("Not BigDecimal"), 1, TEST_CRSMD, Double.class);
            fail("IllegalMappingException expected");
        } catch (IllegalMappingException e) {
            // good
        }
    ...
    public void testConvert10() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Short(TEST_VALUE.byteValue()));
    }
    ...
    public void testConvert11() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Integer(TEST_VALUE.byteValue()));
    }
    ...
    public void testConvert12() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Long(TEST_VALUE.byteValue()));
    }
    ...
    public void testConvert13() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Float(TEST_VALUE.byteValue()));
    }
    ...
    public void testConvert14() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Double(TEST_VALUE.byteValue()));
    }
    ...
    public void testConvert15() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(TEST_VALUE.byteValue()));
    }

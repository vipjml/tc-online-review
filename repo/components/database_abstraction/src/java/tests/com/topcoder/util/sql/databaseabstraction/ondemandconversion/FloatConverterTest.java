...
public class FloatConverterTest extends TestCase {
    ...
    /**
     * Instance of Float used in this unit test case as value parameter.
     */
    private static final Float TEST_VALUE = new Float(2.2356);

    /**
     * Instance of FloatConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:FloatConverter can be instantiated correctly.
     * </p>
     */
    public void testFloatConverter() {
        assertNotNull("Unable to instantiate FloatConverter.", converter);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Float, false is returned.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Float, false is returned.
     * </p>
     */
    public void testCanConvert13() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Float.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Float, IllegalMappingException is thrown.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Float, IllegalMappingException is thrown.
     * </p>
     *
     * @throws Exception
     *             exception to JUnit.
    ...
    public void testConvert13() throws Exception {
        try {
            converter.convert(TEST_VALUE, 1, TEST_CRSMD, Float.class);
            fail("IllegalMappingException expected.");
        } catch (IllegalMappingException e) {
            // good
        }
    ...
    public void testConvert15() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(TEST_VALUE.floatValue()));
    }

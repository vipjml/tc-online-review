...
/**
 * <p>
 * Accuracy Test cases for the class ShortConverter.
 * </p>
 *
 * @author PE
 * @version 1.1
 */
public class ShortConverterAccuracyTestV11 extends TestCase {
    /** Represents the Short instance for testing. */
    private static final Short VALUE = new Short("1");

    /** Represents the ShortConverter instance for testing. */
    ...
    public void testConvert_Accuracy2() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal(VALUE.shortValue()));
    }

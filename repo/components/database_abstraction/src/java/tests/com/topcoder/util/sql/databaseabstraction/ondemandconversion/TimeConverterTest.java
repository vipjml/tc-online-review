...
public class TimeConverterTest extends TestCase {
    ...
    /**
     * Instance of Time used in this unit test case as value parameter.
     */
    private static final Time TEST_VALUE = new Time(100000);

    /**
     * Instance of TimeConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:TimeConverter can be instantiated correctly.
     * </p>
     */
    public void testTimeConverter() {
        assertNotNull("Unable to instantiate TimeConverter.", converter);
    }

    /**
     * <p>
     * Test TimeConverter(DateFormat dateFormat) {.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * Verify:When value is not a Time, false is returned.
     * </p>
     */
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Time, false is returned.
     * </p>
     */
    public void testCanConvert8() {
        assertEquals("canConvert is incorrect.", converter.canConvert(TEST_VALUE, 1, TEST_CRSMD, Time.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Time, IllegalMappingException is thrown.
     * </p>
     */
    public void testConvert8() {
        try {
            converter.convert(TEST_VALUE, 1, TEST_CRSMD, Time.class);
            fail("IllegalMappingException expected");
        } catch (IllegalMappingException e) {
            // good
        }
    ...
    public void testConvert14() throws Exception {
        ...
        TimeConverter converter2 = new TimeConverter(formatter);

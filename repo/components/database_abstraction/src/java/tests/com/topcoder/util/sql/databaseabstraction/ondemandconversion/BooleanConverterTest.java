...
/**
 * Test case for BooleanConverter.
 *
 * @author justforplay
 * @version 1.1
 * @since 1.1
...
public class BooleanConverterTest extends TestCase {
    ...
    /**
     * Instance of Boolean used in this unit test case as value parameter.
     */
    private static final Boolean TEST_VALUE = new Boolean(true);

    /**
     * Instance of Boolean used in this unit test case as value parameter.
     */
    private static final Boolean TEST_VALUE_2 = new Boolean(false);

    /**
     * Instance of BooleanConverter used in this unit test case.
     */
     ...
     * </p>
     * <p>
     * Verify:BooleanConverter can be instantiated correctly.
     * </p>
     */
    public void testBooleanConverter() {
        assertNotNull("Unable to instantiate BooleanConverter.", converter);
    }
     ...
     * </p>
     * <p>
     * Verify:When value is not a Boolean, false is returned.
     * </p>
     */
    public void testCanConvert7() {
        assertEquals("canConvert is incorrect.",
                converter.canConvert(new String("Not Boolean"), 1, TEST_CRSMD, Byte.class), false);
    }
     ...
     * </p>
     * <p>
     * Verify:When desiredType is Boolean, IllegalMappingException is thrown.
     * </p>
     */
    public void testConvert8_1() {
        try {
            converter.convert(TEST_VALUE, 1, TEST_CRSMD, Boolean.class);
            fail("IllegalMappingException expected");
        } catch (IllegalMappingException e) {
            // good
        }
    ...
    public void testConvert9() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Byte("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert9_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Byte.class);
        assertTrue("convert is incorrect.", obj instanceof Byte);
        assertEquals("convert is incorrect.", obj, new Byte("0"));
    }
    ...
    public void testConvert10() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Short("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert10_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Short.class);
        assertTrue("convert is incorrect.", obj instanceof Short);
        assertEquals("convert is incorrect.", obj, new Short("0"));
    }
    ...
    public void testConvert11() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Integer("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert11_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Integer.class);
        assertTrue("convert is incorrect.", obj instanceof Integer);
        assertEquals("convert is incorrect.", obj, new Integer("0"));
    }
    ...
    public void testConvert12() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Long("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert12_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Long.class);
        assertTrue("convert is incorrect.", obj instanceof Long);
        assertEquals("convert is incorrect.", obj, new Long("0"));
    }
    ...
    public void testConvert13() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Float("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert13_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Float.class);
        assertTrue("convert is incorrect.", obj instanceof Float);
        assertEquals("convert is incorrect.", obj, new Float("0"));
    }
    ...
    public void testConvert14() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new Double("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert14_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, Double.class);
        assertTrue("convert is incorrect.", obj instanceof Double);
        assertEquals("convert is incorrect.", obj, new Double("0"));
    }
    ...
    public void testConvert15() throws Exception {
        ...
        assertEquals("convert is incorrect.", obj, new BigDecimal("1"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert15_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, BigDecimal.class);
        assertTrue("convert is incorrect.", obj instanceof BigDecimal);
        assertEquals("convert is incorrect.", obj, new BigDecimal("0"));
    }
     ...
     *             exception to JUnit.
     */
    public void testConvert16_2() throws Exception {
        Object obj = converter.convert(TEST_VALUE_2, 1, TEST_CRSMD, String.class);
        assertTrue("convert is incorrect.", obj instanceof String);
        assertEquals("convert is incorrect.", obj, TEST_VALUE_2.toString());
    }

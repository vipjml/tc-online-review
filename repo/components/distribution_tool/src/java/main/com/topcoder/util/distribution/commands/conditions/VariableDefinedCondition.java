 ...
 * whether variable with specific name is defined in the current execution
 * context.
 * </p>
 *
 * <p>
 ...
 * @version 1.0
 */
public class VariableDefinedCondition implements CommandExecutionCondition {
    /**
     * <p>
    ...
    /**
     * <p>
     * Creates an instance of VariableDefinedCondition.
     * </p>
     *
     * @param name
     ...
     */
    public VariableDefinedCondition(String name) {
     ...
     * variable with specific name is defined.
     * </p>
     *
     *
     * @param context
     *            the distribution script execution context
     * @return true if the condition is met (variable is defined), false
     *         otherwise
     *
     * @throws IllegalArgumentException
     *             if context is null

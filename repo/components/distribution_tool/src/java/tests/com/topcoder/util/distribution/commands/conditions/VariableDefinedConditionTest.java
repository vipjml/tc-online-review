...
/**
 * <p>
 * Unit tests for <code>VariableDefinedCondition</code> class.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.0
...
public class VariableDefinedConditionTest extends TestCase {
    /**
     * <p>
     * The VariableDefinedCondition instance for test.
     * </p>
     */
    ...
    /**
     * Test accuracy of constructor VariableDefinedCondition(String name).
     */
    public void testCtor_Accuracy() {
        target = new VariableDefinedCondition("test");
    ...
    /**
     * Test failure of constructor VariableDefinedCondition(String name) when the name is null, IllegalArgumentException
     * is expected.
     */
    ...
    /**
     * Test failure of constructor VariableDefinedCondition(String name) when the name is empty,

...
create table 'informix'.vm_security_group (
  vm_security_group_id DECIMAL(10,0) NOT NULL  ,
  name VARCHAR(50) NOT NULL ,
  create_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  modify_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  PRIMARY KEY (vm_security_group_id) constraint "informix".vm_security_group_pk
)
extent size 16 next size 16
lock mode row;

revoke all on vm_security_group from 'public';

create table 'informix'.vm_instance_type (
  vm_instance_type_id DECIMAL(10,0) NOT NULL  ,
  name VARCHAR(50) NOT NULL ,
  create_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  modify_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  PRIMARY KEY (vm_instance_type_id) constraint "informix".vm_instance_type_pk
)
extent size 16 next size 16
lock mode row;

revoke all on vm_instance_type from 'public';

create table 'informix'.vm_availability_zone (
  vm_availability_zone_id DECIMAL(10,0) NOT NULL  ,
  name VARCHAR(50) NOT NULL ,
  create_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  modify_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  PRIMARY KEY (vm_availability_zone_id) constraint "informix".vm_availability_zone_pk
)
extent size 16 next size 16
lock mode row;

revoke all on vm_availability_zone from 'public';

create table 'informix'.vm_key_pair (
  vm_key_pair_id DECIMAL(10,0) NOT NULL  ,
  name VARCHAR(50) NOT NULL ,
  create_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  modify_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  PRIMARY KEY (vm_key_pair_id) constraint "informix".vm_key_pair_pk
)
extent size 16 next size 16
lock mode row;

revoke all on vm_key_pair from 'public';

create table 'informix'.vm_image (
...
revoke all on vm_image from 'public';

create table 'informix'.vm_user_data (
  ...
  PRIMARY KEY (vm_user_data_id)  constraint "informix".vm_user_data_pk
)
extent size 32 next size 32
lock mode row;

revoke all on vm_user_data from 'public';

create table 'informix'.vm_image_user_data (
  vm_image_id DECIMAL(10,0) NOT NULL ,
  vm_user_data_id DECIMAL(10,0) NOT NULL ,
  PRIMARY KEY (vm_image_id, vm_user_data_id) constraint "informix".vm_image_user_data_pk
)
extent size 32 next size 32
lock mode row;

revoke all on vm_image_user_data from 'public';

create table 'informix'.vm_account (
...
revoke all on vm_account from 'public';

create table 'informix'.vm_contest_type (
  vm_contest_type_id DECIMAL(10,0) NOT NULL  ,
  name VARCHAR(50) NOT NULL ,
  create_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  modify_date DATETIME YEAR to FRACTION(3) NOT NULL ,
  PRIMARY KEY (vm_contest_type_id) constraint "informix".vm_contest_type_pk
)
extent size 16 next size 16
lock mode row;

revoke all on vm_contest_type from 'public';

create table 'informix'.vm_instance (
...
revoke all on vm_instance from 'public';

create table 'informix'.vm_instance_audit (
...
grant index on vm_instance_type to 'public' as 'informix';

grant delete on vm_instance_type to 'public' as 'informix';

grant select on vm_instance_type to 'public' as 'informix';

grant insert on vm_instance_type to 'public' as 'informix';

grant update on vm_availability_zone to 'public' as 'informix';

grant index on vm_availability_zone to 'public' as 'informix';

grant delete on vm_availability_zone to 'public' as 'informix';

grant select on vm_availability_zone to 'public' as 'informix';

grant insert on vm_availability_zone to 'public' as 'informix';

grant update on vm_key_pair to 'public' as 'informix';

grant index on vm_key_pair to 'public' as 'informix';

grant delete on vm_key_pair to 'public' as 'informix';

grant select on vm_key_pair to 'public' as 'informix';

grant insert on vm_key_pair to 'public' as 'informix';

grant update on vm_image to 'public' as 'informix';

grant index on vm_image to 'public' as 'informix';

grant delete on vm_image to 'public' as 'informix';

grant select on vm_image to 'public' as 'informix';

grant insert on vm_image to 'public' as 'informix';

grant update on vm_user_data to 'public' as 'informix';

grant index on vm_user_data to 'public' as 'informix';

grant delete on vm_user_data to 'public' as 'informix';

grant select on vm_user_data to 'public' as 'informix';

grant insert on vm_user_data to 'public' as 'informix';

grant update on vm_image_user_data to 'public' as 'informix';

grant index on vm_image_user_data to 'public' as 'informix';

grant delete on vm_image_user_data to 'public' as 'informix';

grant select on vm_image_user_data to 'public' as 'informix';

grant insert on vm_image_user_data to 'public' as 'informix';

grant update on vm_account to 'public' as 'informix';

grant index on vm_account to 'public' as 'informix';

grant delete on vm_account to 'public' as 'informix';

grant select on vm_account to 'public' as 'informix';

grant insert on vm_account to 'public' as 'informix';

grant update on vm_contest_type to 'public' as 'informix';

grant index on vm_contest_type to 'public' as 'informix';

grant delete on vm_contest_type to 'public' as 'informix';

grant select on vm_contest_type to 'public' as 'informix';

grant insert on vm_contest_type to 'public' as 'informix';

grant update on vm_instance to 'public' as 'informix';

grant index on vm_instance to 'public' as 'informix';

grant delete on vm_instance to 'public' as 'informix';

grant select on vm_instance to 'public' as 'informix';

grant insert on vm_instance to 'public' as 'informix';

grant update on vm_instance_audit to 'public' as 'informix';

grant index on vm_instance_audit to 'public' as 'informix';

grant delete on vm_instance_audit to 'public' as 'informix';

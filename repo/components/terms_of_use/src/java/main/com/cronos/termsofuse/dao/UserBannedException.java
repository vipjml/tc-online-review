...
public class UserBannedException extends TermsOfUseDaoException {
     ...
     */
    public UserBannedException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            ExceptionData() will be automatically used instead.
     */
    public UserBannedException(String message, Throwable cause, ExceptionData data) {

...
public class TermsOfUseDaoException extends BaseException {
     ...
     */
    public TermsOfUseDaoException(String message) {
        super(message);
    }
     ...
     */
    public TermsOfUseDaoException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public TermsOfUseDaoException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            will be automatically used instead.
     */
    public TermsOfUseDaoException(String message, Throwable cause, ExceptionData data) {

...
/**
 * <p>
 * It is a subclass of <code>AbstractInformixProjectPersistence</code> providing the unmanaged-transaction version of
 ...
 * @version 1.2.4
 */
public class UnmanagedTransactionInformixProjectPersistence extends AbstractInformixProjectPersistence {
    /**
     * Logger instance using the class name as category.
     */
    private static final Log LOGGER = LogManager.getLog(UnmanagedTransactionInformixProjectPersistence.class
        .getName());

    /**
     * <p>
     * Creates a new instance of <code>UnmanagedTransactionInformixProjectPersistence</code> from the settings in
     * configuration.
     * </p>
     * <p>
     ...
     */
    public UnmanagedTransactionInformixProjectPersistence(String namespace) throws ConfigurationException,
    ...
    protected Connection openConnection() throws PersistenceException {
        ...
        return Helper.createConnection(getConnectionFactory(), getConnectionName());
    }

    /**
     * <p>
     * Concrete implementation of the corresponding abstract method in
     * <code>AbstractInformixProjectPersistence.</code> used to close the connection after an operation successfully
     * completes.
     * </p>
     *

...
/**
 * <p>
 * It is a subclass of <code>AbstractInformixProjectPersistence</code> manage the transaction itself.
 * </p>
 *
 * <p>
 * The implementations of <code>openConnection()</code>, <code>closeConnection(Connection)</code> and
 * <code>closeConnectionOnError(Connection)</code> call the transaction management related method like
 * <code>commit()</code>, <code>setAutoCommit(boolean)</code> or <code>rollback()</code> to manage the transaction as
 * in the version 1.0.1.
 * </p>
 *
 * <p>
 * <b>Note:</b> The <code>InformixProjectPersistence</code> class in version 1.1 is completely compatible with the
 * <code>InformixProjectPersistence</code> class in version 1.0.1 and has no additional functionality. However, the
 * bulk of the logic that was in this class in version 1.0.1 has been moved into an abstract superclass that is the
 * base for <code>UnmanagedTransactionInformixProjectPersistence</code> as well.
 * </p>
 *
 * <p>
 * <b>Thread Safety</b>: The implementation is not thread safe due to the base class is not thread safe.
 * </p>
 *
 ...
 * @since 1.0
 */
public class InformixProjectPersistence extends AbstractInformixProjectPersistence {
    /**
    ...
    /**
     * <p>
     * Creates a new instance of <code>InformixProjectPersistence</code> from the settings in configuration.
     * </p>
     * <p>
     ...
     */
    public InformixProjectPersistence(String namespace) throws ConfigurationException, PersistenceException {
        super(namespace);
    }
    ...
    protected Connection openConnection() throws PersistenceException {
        ...
        if (connectionName == null) {
            LOGGER.log(Level.DEBUG, new LogMessage(null, null, "creating db connection using default connection"));
        } else {
     ...
     * <p>
     * Concrete implementation of the corresponding abstract method in
     * <code>AbstractInformixProjectPersistence.</code> used to commit the transaction and close the connection after

...
3. Modify connection setting in "test_files/dbfactory.xml".

4. Ant test.

There are some notes for you:
0. The createRoleTermOfUse method is final fix issue. See: 
    http://forums.topcoder.com/?module=Thread&threadID=693964&start=0

1. Please use the correct old source here: http://forums.topcoder.com/?module=Thread&threadID=693781&start=0

2. You should only consider the coverage report for the new sources, not the old sources.
...
4. The tests added or updated are:
    AbstractInformixProjectPersistenceV12UnitTests.java
    DemoV12Test.java

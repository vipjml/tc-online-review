...
public class ConfigurationExceptionTests extends TestCase {
    ...
    public void testConfigurationException2() {
        ConfigurationException exception = new ConfigurationException(ERROR_MESSAGE, CAUSE_EXCEPTION);
     ...
     *
     * <p>
     * Verifies ConfigurationException subclasses Exception.
     * </p>
     */
    public void testConfigurationExceptionInheritance1() {
        ConfigurationException exception = new ConfigurationException(ERROR_MESSAGE);
        assertTrue("ConfigurationException does not subclass Exception.", exception instanceof Exception);
    }

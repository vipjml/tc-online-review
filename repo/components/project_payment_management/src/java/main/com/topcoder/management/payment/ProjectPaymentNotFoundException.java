...
/**
 * <p>
 * This exception is thrown by implementations of managers and persistence interfaces if project payment with given id
 ...
 * @version 1.0
 */
public class ProjectPaymentNotFoundException extends ProjectPaymentManagementException {
    /**
     * The serial version ID.
     */
    private static final long serialVersionUID = -6196160039142353900L;
     ...
     */
    public ProjectPaymentNotFoundException(String message) {
        super(message);
    }
     ...
     */
    public ProjectPaymentNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     */
    public ProjectPaymentNotFoundException(String message, ExceptionData data) {
        super(message, data);
    }
     ...
     *            ExceptionData() will be automatically used instead.
     */
    public ProjectPaymentNotFoundException(String message, Throwable cause, ExceptionData data) {

...
INSERT INTO 'informix'.project(project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, tc_direct_project_id) VALUES(1001, 1, 1, 'admin', CURRENT, 'admin', CURRENT, 1);
INSERT INTO 'informix'.project(project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, tc_direct_project_id) VALUES(1002, 1, 2, 'admin', CURRENT, 'admin', CURRENT, 1);
INSERT INTO 'informix'.project(project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, tc_direct_project_id) VALUES(1003, 1, 3, 'admin', CURRENT, 'admin', CURRENT, 1);
INSERT INTO 'informix'.project(project_id, project_status_id, project_category_id, create_user, create_date, modify_user, modify_date, tc_direct_project_id) VALUES(1004, 1, 3, 'admin', CURRENT, 'admin', CURRENT, 1);

INSERT INTO 'informix'.resource(resource_id, resource_role_id, project_id, project_phase_id ,create_user,create_date,modify_user,modify_date) VALUES (1001, 2, 100001, 111, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO 'informix'.resource(resource_id, resource_role_id, project_id, project_phase_id ,create_user,create_date,modify_user,modify_date) VALUES (1002, 4, 100002, 111, 'admin', CURRENT, 'admin', CURRENT);


INSERT INTO 'informix'.submission (submission_id, upload_id, submission_status_id, screening_score, initial_score, final_score, placement, submission_type_id, create_user, create_date, modify_user, modify_date) VALUES(1011111, 1, 1, 100, 100, 100, 1, 1, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO 'informix'.submission (submission_id, upload_id, submission_status_id, screening_score, initial_score, final_score, placement, submission_type_id, create_user, create_date, modify_user, modify_date) VALUES(1022222, 2, 2, 100, 100, 100, 1, 1, 'admin', CURRENT, 'admin', CURRENT);

INSERT INTO 'informix'.upload (upload_id, project_id, project_phase_id, resource_id, upload_type_id, upload_status_id, parameter, upload_desc, create_user, create_date, modify_user, modify_date) VALUES(1, 1001, 1, 1, 1, 1, 1, 1, 'admin', CURRENT, 'admin', CURRENT);
INSERT INTO 'informix'.upload (upload_id, project_id, project_phase_id, resource_id, upload_type_id, upload_status_id, parameter, upload_desc, create_user, create_date, modify_user, modify_date) VALUES(2, 1002, 1, 1, 1, 1, 1, 1, 'admin', CURRENT, 'admin', CURRENT);

INSERT INTO 'informix'.project_payment (project_payment_id, project_payment_type_id, resource_id, submission_id, amount, pacts_payment_id, create_user, create_date, modify_user, modify_date) VALUES(1, 1, 1001, 1011111, 500.0, 4, "testOperator", CURRENT, "testOperator", CURRENT);
INSERT INTO 'informix'.project_payment (project_payment_id, project_payment_type_id, resource_id, submission_id, amount, pacts_payment_id, create_user, create_date, modify_user, modify_date) VALUES(2, 1, 1002, 1022222, 800.0, 3, "testOperator", CURRENT, "testOperator", CURRENT);

INSERT INTO 'informix'.project_payment_adjustment (project_id, resource_role_id, fixed_amount, multiplier) VALUES(1001, 4, 50.0, null);
INSERT INTO 'informix'.project_payment_adjustment (project_id, resource_role_id, fixed_amount, multiplier) VALUES(1002, 3, 0.0, null);
INSERT INTO 'informix'.project_payment_adjustment (project_id, resource_role_id, fixed_amount, multiplier) VALUES(1003, 13, 100.0, null);

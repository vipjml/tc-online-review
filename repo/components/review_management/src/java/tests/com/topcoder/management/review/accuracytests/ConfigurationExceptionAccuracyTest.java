...
public class ConfigurationExceptionAccuracyTest extends TestCase {
    ...
    public void testCtor3() {
        ...
        ConfigurationException exception = new ConfigurationException(message, cause, data);
    ...
    public void testCtor4() {
        ExceptionData data = new ExceptionData();
        data.setApplicationCode("app");
        ConfigurationException exception = new ConfigurationException(message, data);

...
public class ChainFilterStressTest extends TestCase {
    ...
    public void testAnd() {
        ...
        for (int i = 0; i < RUN_TIMES; i++) {
            ...
            assertEquals("Should be the equal.", expectedFilter.getFilterType()
                    , resultFilter.getFilterType());
            assertEquals("Should be the equal.", chainFilter.getFilter().getFilterType()

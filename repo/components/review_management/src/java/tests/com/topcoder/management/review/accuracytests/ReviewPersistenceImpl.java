...
public class ReviewPersistenceImpl implements ReviewPersistence {
    ...
    /**Counter for removeReview method calls.*/
    private int removeReviewCallCount = 0;
    ...
    public void removeReview(long id, String operator)
            throws ReviewPersistenceException {
        removeReviewCallCount++;
    }

    /**
     * <p>
     * Returns removeReviewCallCount variable.
     * </p>
     *
     * @return removeReviewCallCount
     */
    public int getRemoveReviewCallCount() {
        return removeReviewCallCount;
    }
}
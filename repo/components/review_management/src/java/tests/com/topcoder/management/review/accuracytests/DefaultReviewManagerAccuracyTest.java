...
public class DefaultReviewManagerAccuracyTest extends TestCase {
    ...
    /**
     * <p>
     * Test method removeReview().
     * Since DefaultReviewManager.removeReview should simply call persistence.removeReview,
     * we only check that method persistence.removeReview really was called.
     * </p>
     *
     * @throws Exception exception
     */
    public void testRemoveReview() throws Exception {
        assertEquals(0, persistence.getRemoveReviewCallCount());

        //now call three times reviewManager.removeReview
        reviewManager.removeReview(1, "operator1");
        reviewManager.removeReview(2, "operator2");
        reviewManager.removeReview(3, "operator3");

        assertEquals("ReviewPersistence.removeReview method was not called.",
                3, persistence.getRemoveReviewCallCount());
    }
}
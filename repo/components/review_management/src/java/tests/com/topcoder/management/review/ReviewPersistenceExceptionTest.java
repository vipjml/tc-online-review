...
/**
 * <p>
 * This class tests the <code>ReviewPersistenceException</code> class.
 * </p>
 *
 * <p>
...
public class ReviewPersistenceExceptionTest extends TestCase {
    ...
    /**
     * <p>
     * <code>ReviewPersistenceException</code> should be subclass of <code>ReviewManagementException</code>.
     * </p>
     *
     * @since 1.2
     */
    public void testInheritance() {
        assertTrue("ReviewPersistenceException should be subclass of ReviewManagementException.",
            ReviewPersistenceException.class.getSuperclass() == ReviewManagementException.class);
    }

    /**
     * <p>
     * Tests accuracy of <code>ReviewPersistenceException(String)</code> constructor.<br>
     * The detail error message should be properly set.
     * </p>
     */
    public void testCtor1() {
        ReviewPersistenceException exception = new ReviewPersistenceException(DETAIL_MESSAGE);
    ...
    /**
     * <p>
     * Tests accuracy of <code>ReviewPersistenceException(String, Throwable)</code> constructor.<br>
     * The detail error message and the original cause of error should be properly set.
     * </p>
     */
    public void testCtor2() {
        ReviewPersistenceException exception = new ReviewPersistenceException(DETAIL_MESSAGE, CAUSE);
    ...
    /**
     * <p>
     * Tests accuracy of <code>ReviewPersistenceException(String, ExceptionData)</code> constructor.<br>
    ...
    public void testCtor3() {
        ReviewPersistenceException exception = new ReviewPersistenceException(DETAIL_MESSAGE, EXCEPTION_DATA);
    ...
    /**
     * <p>
     * Tests accuracy of <code>ReviewPersistenceException(String, Throwable, ExceptionData)</code> constructor.<br>
    ...
    public void testCtor4() {
        ReviewPersistenceException exception = new ReviewPersistenceException(DETAIL_MESSAGE, CAUSE, EXCEPTION_DATA);

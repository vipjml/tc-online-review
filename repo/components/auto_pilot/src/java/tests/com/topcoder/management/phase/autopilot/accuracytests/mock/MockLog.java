...
/**
 * <p>A mock implementation of {@link Log} class to be used for testing.
...
public class MockLog implements Log {
    ...
    /**
     * <p>Releases the state of <code>MockLog</code> so all collected method arguments,

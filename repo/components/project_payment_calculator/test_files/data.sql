...
-- Project
INSERT INTO 'informix'.project(project_id,project_status_id,project_category_id,project_studio_spec_id,create_user,create_date,modify_user,modify_date,tc_direct_project_id) VALUES (230, 1, 1, 1, 'System', current, 'System', current, 1);
INSERT INTO 'informix'.project(project_id,project_status_id,project_category_id,project_studio_spec_id,create_user,create_date,modify_user,modify_date,tc_direct_project_id) VALUES (231, 1, 2, 1, 'System', current, 'System', current, 1);
INSERT INTO 'informix'.project(project_id,project_status_id,project_category_id,project_studio_spec_id,create_user,create_date,modify_user,modify_date,tc_direct_project_id) VALUES (232, 1, 3, 1, 'System', current, 'System', current, 1);
INSERT INTO 'informix'.project(project_id,project_status_id,project_category_id,project_studio_spec_id,create_user,create_date,modify_user,modify_date,tc_direct_project_id) VALUES (233, 1, 4, 1, 'System', current, 'System', current, 1);

INSERT INTO 'informix'.prize(prize_id,project_id,place,prize_amount,prize_type_id,number_of_submissions,create_user,create_date,modify_user,modify_date) VALUES (1, 230, 1, 500, 15, 3, 'System', current, 'System', current);
INSERT INTO 'informix'.prize(prize_id,project_id,place,prize_amount,prize_type_id,number_of_submissions,create_user,create_date,modify_user,modify_date) VALUES (2, 231, 1, 400, 15, 3, 'System', current, 'System', current);
INSERT INTO 'informix'.prize(prize_id,project_id,place,prize_amount,prize_type_id,number_of_submissions,create_user,create_date,modify_user,modify_date) VALUES (3, 232, 1, 650, 15, 3, 'System', current, 'System', current);
INSERT INTO 'informix'.prize(prize_id,project_id,place,prize_amount,prize_type_id,number_of_submissions,create_user,create_date,modify_user,modify_date) VALUES (4, 233, 1, 1000, 15, 3, 'System', current, 'System', current);

INSERT INTO 'informix'.project_phase(project_phase_id,project_id,phase_type_id,phase_status_id,fixed_start_time,scheduled_start_time,scheduled_end_time,actual_start_time,actual_end_time,duration,create_user,create_date,modify_user,modify_date) VALUES (1, 230, 4, 2, current, current, current, current, current, 1000, 'System', current, 'System', current);
INSERT INTO 'informix'.project_phase(project_phase_id,project_id,phase_type_id,phase_status_id,fixed_start_time,scheduled_start_time,scheduled_end_time,actual_start_time,actual_end_time,duration,create_user,create_date,modify_user,modify_date) VALUES (2, 232, 4, 2, current, current, current, current, current, 1000, 'System', current, 'System', current);
INSERT INTO 'informix'.project_phase(project_phase_id,project_id,phase_type_id,phase_status_id,fixed_start_time,scheduled_start_time,scheduled_end_time,actual_start_time,actual_end_time,duration,create_user,create_date,modify_user,modify_date) VALUES (3, 233, 4, 2, current, current, current, current, current, 1000, 'System', current, 'System', current);

INSERT INTO 'informix'.resource(resource_id,resource_role_id,project_id,project_phase_id,create_user,create_date,modify_user,modify_date) VALUES (1, 1, 230, 1, 'System', current, 'System', current);
INSERT INTO 'informix'.resource(resource_id,resource_role_id,project_id,project_phase_id,create_user,create_date,modify_user,modify_date) VALUES (2, 1, 232, 1, 'System', current, 'System', current);
INSERT INTO 'informix'.resource(resource_id,resource_role_id,project_id,project_phase_id,create_user,create_date,modify_user,modify_date) VALUES (3, 1, 233, 1, 'System', current, 'System', current);

INSERT INTO 'informix'.upload(upload_id,project_id,project_phase_id,resource_id,upload_type_id,upload_status_id,parameter,upload_desc,create_user,create_date,modify_user,modify_date) VALUES (500, 230, 1, 1, 1, 1, 'param', 'upload', 'System', current, 'System', current);
INSERT INTO 'informix'.upload(upload_id,project_id,project_phase_id,resource_id,upload_type_id,upload_status_id,parameter,upload_desc,create_user,create_date,modify_user,modify_date) VALUES (623, 230, 1, 1, 1, 1, 'param', 'upload', 'System', current, 'System', current);
INSERT INTO 'informix'.upload(upload_id,project_id,project_phase_id,resource_id,upload_type_id,upload_status_id,parameter,upload_desc,create_user,create_date,modify_user,modify_date) VALUES (46, 233, 3, 1, 1, 1, 'param', 'upload', 'System', current, 'System', current);
...
INSERT INTO 'informix'.submission (submission_id,upload_id,submission_status_id,submission_type_id,create_user,create_date,modify_user,modify_date) VALUES (3, 46, 7, 3, 'System', current, 'System', current);
...
INSERT INTO 'informix'.default_project_payment(project_category_id,resource_role_id,fixed_amount,base_coefficient,incremental_coefficient) VALUES (2, 19, 10.0, 0.01, 0.02);
...
INSERT INTO 'informix'.project_payment_adjustment(project_id,resource_role_id,fixed_amount) VALUES (230,2,14);
INSERT INTO 'informix'.project_payment_adjustment(project_id,resource_role_id,fixed_amount) VALUES (230,4,22);
INSERT INTO 'informix'.project_payment_adjustment(project_id,resource_role_id,multiplier) VALUES (230,5,3);
INSERT INTO 'informix'.project_payment_adjustment(project_id,resource_role_id,multiplier) VALUES (230,8,2);
INSERT INTO 'informix'.project_payment_adjustment(project_id,resource_role_id) VALUES (230,9);

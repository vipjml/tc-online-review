...
/**
 * <p>
 * Mock class for Project. Here we need this mock class because Project Phases 2.0 is not available
 * at now.
 * </p>
 *
 * @author still
...
final class StressMockProject extends Project {
    ...
    public StressMockProject() {
        super(null, new DefaultWorkdaysFactory(true).createWorkdaysInstance());
    }

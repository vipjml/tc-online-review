...
/**
 * <p>
 * Accuracy test fixture for PhaseValidationException class.
 * </p>
 *
 * @author Thinfox, stevenfrog
 * @version 1.1
 */
public class PhaseValidationExceptionAccTests extends TestCase {
	/**
	 * <p>
	...
	public void testConstructor_Message() {
		Exception exception = new PhaseValidationException(ERROR_MESSAGE);
	...
	public void testConstructor_MessageCause() {
		...
		Exception exception = new PhaseValidationException(ERROR_MESSAGE, cause);
		assertTrue("Incorrect inheritance.", exception instanceof BaseCriticalException);
	...
	public void testConstructor_MessageData() {
		...
		PhaseValidationException exception = new PhaseValidationException(ERROR_MESSAGE, data);
		assertTrue("Incorrect inheritance.", exception instanceof BaseCriticalException);
		assertEquals("Incorrect error message.", ERROR_MESSAGE, exception.getMessage());
	...
	public void testConstructor_MessageCauseData() {
		...
		ExceptionData data = new ExceptionData();
		data.setApplicationCode("AppCode");
		PhaseValidationException exception = new PhaseValidationException(ERROR_MESSAGE, cause,
			data);
		assertTrue("Incorrect inheritance.", exception instanceof BaseCriticalException);
		assertEquals("Incorrect error message.", ERROR_MESSAGE, exception.getMessage());
		assertEquals("Incorrect cause.", cause, exception.getCause());

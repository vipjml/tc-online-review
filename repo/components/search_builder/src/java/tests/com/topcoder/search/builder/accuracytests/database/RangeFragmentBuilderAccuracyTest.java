...
/**
 * <p>An accuracy test for {@link RangeFragmentBuilder} class. Tests the methods
...
public class RangeFragmentBuilderAccuracyTest extends TestCase {
     ...
     */
    private static Pattern SEARCH_STRING_NO_ALIAS_PATTERN_GREATER = Pattern.compile("attr1[ ]*>[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_ALIAS_PATTERN_GREATER = Pattern.compile("attr2[ ]*>[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_NO_ALIAS_PATTERN_GREATER_OR_EQUAL = Pattern.compile("attr1[ ]*>=[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_ALIAS_PATTERN_GREATER_OR_EQUAL = Pattern.compile("attr2[ ]*>=[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_NO_ALIAS_PATTERN_LESS = Pattern.compile("attr1[ ]*<[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_ALIAS_PATTERN_LESS = Pattern.compile("attr2[ ]*<[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_NO_ALIAS_PATTERN_LESS_OR_EQUAL = Pattern.compile("attr1[ ]*<=[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_ALIAS_PATTERN_LESS_OR_EQUAL = Pattern.compile("attr2[ ]*<=[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_NO_ALIAS_PATTERN_BETWEEN
        = Pattern.compile("attr1[ ]*>=[ ]*\\?[ ]*AND[ ]*attr1[ ]*<=[ ]*\\?");

    /**
     * <p>A <code>Pattern</code> to be used to match the generated search string to expected value.</p>
     */
    private static Pattern SEARCH_STRING_ALIAS_PATTERN_BETWEEN
        = Pattern.compile("attr2[ ]*>=[ ]*\\?[ ]*AND[ ]*attr2[ ]*<=[ ]*\\?");
    ...
    public void testBuildSearch_Filter_SearchContext_NoAliasUsed_Greater() throws Exception {
        for (int i = 0; i < this.testedInstances.length; i++) {
            ...
            Assert.assertEquals("The parameters are not collected correctly", 1, bindParameters.size());
    ...
    public void testBuildSearch_Filter_SearchContext_NoAliasUsed_Between() throws Exception {
        for (int i = 0; i < this.testedInstances.length; i++) {
            ...
            Assert.assertEquals("The parameters are not collected correctly", "1", bindParameters.get(0));
            Assert.assertEquals("The parameters are not collected correctly", "2", bindParameters.get(1));
        }
    }
    ...
    public void testBuildSearch_Filter_SearchContext_AliasUsed_Between() throws Exception {
        for (int i = 0; i < this.testedInstances.length; i++) {
            ...
            List bindParameters = searchContext.getBindableParameters();
            Assert.assertEquals("The parameters are not collected correctly", 2, bindParameters.size());
            Assert.assertEquals("The parameters are not collected correctly", "4", bindParameters.get(0));
            Assert.assertEquals("The parameters are not collected correctly", "5", bindParameters.get(1));
        }
    }
}

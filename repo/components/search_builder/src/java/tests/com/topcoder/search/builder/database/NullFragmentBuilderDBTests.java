...
/**
 * <p>
 * Unit test cases for NullFragmentBuilder.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.3
 */
public class NullFragmentBuilderDBTests extends TestCase {
    /**
     * The namespace.
     */
     ...
     */
    private NullFragmentBuilder builder = null;
    /**
     * The AndFilter.
     */
    ...
    public void testbuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.", "name IS NULL",

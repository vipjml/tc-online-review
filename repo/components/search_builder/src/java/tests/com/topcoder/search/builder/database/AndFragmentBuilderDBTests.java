...
/**
 * <p>
 * Unit test cases for AndFragmentBuilder.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.3
 */
public class AndFragmentBuilderDBTests extends TestCase {
    /**
     * The namespace.
     */
     ...
     */
    private AndFragmentBuilder builder = null;
    /**
     * The AndFilter.
     */
    ...
    protected void setUp() throws Exception {
        ...
        filter =  new AndFilter(invalid, filter2);
    ...
    public void testbuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.", "(sn = ? AND sn = ?)",

...
/**
 * <p>
 * Unit test cases for LikeFragmentBuilder.
 * </p>
 *
 * @author TCSDEVELOPER
 * @version 1.3
 */
public class LikeFragmentBuilderDBTests extends TestCase {
    /**
     * The namespace.
     */
     ...
     */
    private LikeFragmentBuilder builder = null;
    /**
     * The AndFilter.
     */
    ...
    protected void setUp() throws Exception {
        ...
        aliasMap.put("sn", "sn");
        filter = new LikeFilter("sn", "EW:2");
        Filter filter2 = new EqualToFilter("sn", "1");
        invalid =  new OrFilter(filter, filter2);
    ...
    public void testbuildSearch_accuracy() throws Exception {
        ...
        assertEquals("the generated String should be same.", "sn LIKE ? ESCAPE ?",

...
/**
 * Failure test cases for LessThanOrEqualToFilter.
 *
 * @author WishingBone
 * @version 1.1
 */
public class LessThanOrEqualToFilterFailureTests extends TestCase {
    ...
    private Filter createFilter() {
        return new LessThanOrEqualToFilter("quantity", new Integer(12));
    }
    ...
    public void testCreate_NullName() {
        try {
            new LessThanOrEqualToFilter(null, new Integer(12));
    ...
    public void testCreate_NullValue() {
        try {
            new LessThanOrEqualToFilter("name", null);
            fail("Should have thrown IllegalArgumentException.");
        } catch (IllegalArgumentException npe) {
        }
    }
    ...
    public void testCreate_EmptyName() {
        try {
            new LessThanOrEqualToFilter("", new Integer(12));
            fail("Should have thrown IllegalArgumentException.");

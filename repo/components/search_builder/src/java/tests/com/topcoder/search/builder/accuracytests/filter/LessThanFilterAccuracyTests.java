...
/**
 * <p>
 * Accuracy test cases for LessThanFilter.
 * </p>
 *
 * @author zjq
 * @version 1.1
 */
public class LessThanFilterAccuracyTests extends TestCase {
    /**
    ...
    public void testIsLowerUpperInclusive() {
        assertFalse("limits should not be inclusive", lessThanFilter.isUpperInclusive());
    }
    ...
    public void testisValid4() {
        ...
        ValidationResult result = lessThanFilter.isValid(map, alias);
    ...
    public void testgetFilterType() {
        assertEquals("The getFilterType should return Filter.LESS_THAN_FILTER", Filter.LESS_THAN_FILTER,
            lessThanFilter.getFilterType());
    }

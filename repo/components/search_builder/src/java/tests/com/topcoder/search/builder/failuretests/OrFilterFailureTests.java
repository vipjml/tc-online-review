...
/**
 * Failure test cases for OrFilter.
 *
 * @author WishingBone
 * @version 1.1
 */
public class OrFilterFailureTests extends TestCase {
    ...
    private AbstractAssociativeFilter createFilter() {
        return new OrFilter(new EqualToFilter("quantity", new Integer(12)), new EqualToFilter("size", new Integer(3)));
    }
    ...
    public void testCreate_NullFilter1() {
        try {
            new OrFilter(null, new EqualToFilter("quantity", new Integer(12)));
    ...
    public void testCreate_NullFilter2() {
        try {
            new OrFilter(new EqualToFilter("quantity", new Integer(12)), null);
            fail("Should have thrown IllegalArgumentException.");
        } catch (IllegalArgumentException npe) {
        }
    }

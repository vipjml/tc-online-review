...
/**
 * Failure tests for <code>AndFragmentBuilder</code>.
 *
 * @author assistant
 * @version 1.3
 */
public class AndFragmentBuilderTest13 extends TestCase {

    /**
     * Represents the builder to test.
     */
    private AndFragmentBuilder builder = new AndFragmentBuilder();
    ...
    public void testBuildSearchNullSearchContext() throws Exception {
        try {
            builder.buildSearch(new AndFilter(new EqualToFilter("a", "a"),

...
/**
 * Failure test cases for LessThanFilter.
 *
 * @author WishingBone
 * @version 1.1
 */
public class LessThanFilterFailureTests extends TestCase {
    ...
    private Filter createFilter() {
        return new LessThanFilter("quantity", new Integer(12));
    }
    ...
    public void testCreate_NullName() {
        try {
            new LessThanFilter(null, new Integer(12));
    ...
    public void testCreate_EmptyName() {
        try {
            new LessThanFilter("", new Integer(12));
            fail("Should have thrown IllegalArgumentException.");

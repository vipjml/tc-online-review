...
/**
 * <p>An accuracy test for {@link AndFragmentBuilder} class. Tests the methods for
...
public class AndFragmentBuilderAccuracyTest extends TestCase {
    ...
    private static Pattern SEARCH_STRING_PATTERN
        = Pattern.compile("\\(\\(attr1=1\\)[ ]*AND[ ]*\\(attr2=2\\)[ ]*AND[ ]*\\(attr3=3\\)[ ]*AND[ ]*\\(attr4=4\\)[ ]*AND[ ]*\\(attr5=5\\)\\)");

    /**
     * <p>The instances of {@link AndFragmentBuilder} which are tested. These instances are initialized in {@link

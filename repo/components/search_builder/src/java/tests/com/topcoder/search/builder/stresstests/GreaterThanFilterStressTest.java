...
/**
 * <p>
 * This class contains the stress unit tests for the GreaterThanFilter. change according to 1.3.
 * </p>
 *
 * @author PE, brain_cn
 * @version 1.3
 */
public class GreaterThanFilterStressTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(GreaterThanFilterStressTest.class);
    }
     ...
     * @throws Exception to JUnit
     */
    public void testGreaterThanFilterStressOfDatabaseConnectionStrategy()
        throws Exception {
        GreaterThanFilterThread[] threads = new GreaterThanFilterThread[THREAD_COUNT];
        ...
        Filter filter = new GreaterThanFilter("price", new Integer(1));

        for (int i = 0; i < threads.length; i++) {
            threads[i] = new GreaterThanFilterThread();
        ...
        System.out.println("GreaterThanFilterStressOfDatabaseConnectionStrategy() tested: " +
     ...
     * @throws Exception to JUnit
     */
    public void testGreaterThanFilterStressOfLDAPConnectionStrategy()
        throws Exception {
        GreaterThanFilterThread[] threads = new GreaterThanFilterThread[THREAD_COUNT];
        ...
        Filter filter = new GreaterThanFilter("sn", "3");
        ...
        long dure = System.currentTimeMillis() - startTime;
        System.out.println("testGreaterThanFilterStressOfLDAPConnectionStrategy() tested: " +
            Integer.toString(THREAD_COUNT) + " threads, " + Long.toString(dure) + " ms.");
...
class GreaterThanFilterThread extends Thread {

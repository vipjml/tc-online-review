...
/**
 * <p>
 * This class contains the stress unit tests for the OrFilter. change according to 1.3.
 * </p>
 *
 * @author PE, brain_cn
 * @version 1.3
 */
public class OrFilterStressTest extends TestCase {
    ...
    public static Test suite() {
        return new TestSuite(OrFilterStressTest.class);
    }
     ...
     * @throws Exception to JUnit
     */
    public void testOrFilterStressOfDatabaseConnectionStrategy()
        throws Exception {
        OrFilterThread[] threads = new OrFilterThread[THREAD_COUNT];
        ...
        System.out.println("OrFilterStressOfDatabaseConnectionStrategy() tested: " + Integer.toString(THREAD_COUNT) +
     ...
     */
    public void testOrFilterStressOfLDAPConnectionStrategy()
        throws Exception {
        OrFilterThread[] threads = new OrFilterThread[THREAD_COUNT];
        ...
        long dure = System.currentTimeMillis() - startTime;
        System.out.println("testOrFilterStressOfLDAPConnectionStrategy() tested: " + Integer.toString(THREAD_COUNT) +
            " threads, " + Long.toString(dure) + " ms.");
...
class OrFilterThread extends Thread {

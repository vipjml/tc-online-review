...
/**
 * Failure tests for the SynchronizedConfigurationObject class of 1.1.
 *
 * @author gjw99
 * @version 1.1
 */
public class SynchronizedConfigurationObjectV11Tests extends TestCase {

    /** The test SynchronizedConfigurationObject instance. */
    private SynchronizedConfigurationObject instance = null;
     ...
     */
    public void setUp() {
        instance = new SynchronizedConfigurationObject(new DefaultConfigurationObject("test"));
    }

...
/**
 * Mock initial context factory for testing purposes only. Currently the
...
/**
 * Extension of initial context that always only ever returns a DataSource to
 * connect to the database used for personal unit testing.
 */
class MockContext extends InitialContext {
    ...
    /**
     * In this simple mock implementation, this method only ever returns a
     * DataSource object pointing at the database used for unit testing.
     *
     * @param key Ignored
     *
...
/**
 * Mock implementation of DataSource that only ever points at my personal copy
 * of database (depends on the configuration file) for unit testing purposes only.
 */
class MockDataSource implements DataSource {
    /**
     * The the configuration file to load the necessary configuration values
     * to create a connection.
     */
    private static final String DB_CONFIG_FILE = "test_files/database.properties";
    ...
    public Connection getConnection() throws SQLException {
        ...
        try {
            ...
            String dbdriver = prop.getProperty("drivername");

...
/**
 * A helper class provides some convenient methods which will be shared by all the tests. A utility
...
final class ConfigHelper {
     ...
     */
    public static final String CLIENT_FILE_LOCATION = "test_files/client/stress";
    ...
    public static final String IPSERVER_MANAGER_CONFIG_FILE = "IPServerManagerConfig.xml";

    /** The file to configure message factory. */
    public static final String MESSAGE_FACTORY_CONFIG_FILE = "MessageFactoryConfig.xml";

    /**
     * the file to configure DBConnectionFactoryImpl.
     */
    public static final String DBCONNECTION_FACTORY_CONFIG_FILE = "DBConnectionFactoryImpl.xml";
    ...
    private ConfigHelper() {
        try {
            ...
            this.ipServer = new IPServer(this.address, this.port, this.maxConnections, 0,
                MESSAGE_FACTORY_NAMESPACE);
    ...
    static void loadNamespaces() throws Exception {
        ...
        cm.add(new File("test_files/stresstests/stress2.xml").getAbsolutePath());
    }

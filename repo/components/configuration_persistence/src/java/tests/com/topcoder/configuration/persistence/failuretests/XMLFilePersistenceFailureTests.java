...
/**
 * <p>
 * Test the functionality of class <code>XMLFilePersistence</code>.
 * </p>
 * 
 * <p>
 ...
 * @version 1.0
 */
public class XMLFilePersistenceFailureTests extends TestCase {
	 /**
     * <p>
    ...
    /**
     * <p>
     * Represents an instance of <code>XMLFilePersistence</code> for testing.<br>
     * It is initialized in <code>setUp()</code> method and released in <code>tearDown()</code> method.
     * </p>
     */
    private XMLFilePersistence xmlFilePersistence = null;
    ...
    protected void setUp() throws Exception {
        super.setUp();
        xmlFilePersistence = new XMLFilePersistence();
    ...
    public void testLoadFile_StringFile_IOException() throws Exception {
        try {
            xmlFilePersistence.loadFile(NAMESPACE, new File("not_existed_file"));
     ...
     * @throws Exception to JUnit
     */
    public void testLoadFile_StringFile_ConfigurationParserException()
        throws Exception {
        try {
            xmlFilePersistence.loadFile(NAMESPACE, new File("test_files/failuretests/parser_error.xml"));
    ...
    public void testLoadFile_StringFile_Null1() throws Exception {
        try {
            xmlFilePersistence.loadFile(null, testFile);
    ...
    public void testLoadFile_StringFile_Null2() throws Exception {
        try {
            xmlFilePersistence.loadFile(NAMESPACE, null);
            fail("Test failure for loadFile() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testLoadFile_StringFile_Empty1() throws Exception {
        try {
            xmlFilePersistence.loadFile("      ", testFile);
            fail("Test failure for loadFile() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
    ...
    public void testSaveFile_FileConfigurationObject_Null1()
        throws Exception {
        try {
            xmlFilePersistence.saveFile(null, configurationObject);
     ...
     * @throws Exception to JUnit
     */
    public void testSaveFile_FileConfigurationObject_Null2()
        throws Exception {
        try {
            xmlFilePersistence.saveFile(tempFile, null);
            fail("Test failure for saveFile() failed, IllegalArgumentException expected.");
        } catch (IllegalArgumentException iae) {
            // Success
        }
